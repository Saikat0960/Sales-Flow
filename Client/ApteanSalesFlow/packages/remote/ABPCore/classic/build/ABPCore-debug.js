...
Ext.define('ABP.SenchaTextOverrides.data.validator.Bound', {override:'Ext.data.validator.Bound', getEmptyMessage:function() {
...
Ext.define('ABP.SenchaTextOverrides.data.validator.Email', {override:'Ext.data.validator.Email', getMessage:function(al) {
  return ABP.util.Common.geti18nString('s_dataValidator_email_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Exclusion', {override:'Ext.data.validator.Exclusion', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_exclusion_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.IPAddress', {override:'Ext.data.validator.IPAddress', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_ipaddress_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Format', {override:'Ext.data.validator.Format', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_format_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Number', {override:'Ext.data.validator.Number', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_number_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Inclusion', {override:'Ext.data.validator.Inclusion', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_inclusion_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Length', {override:'Ext.data.validator.Length', getMinOnlyMessage:function() {
...
Ext.define('ABP.SenchaTextOverrides.data.validator.Presence', {override:'Ext.data.validator.Presence', getMessage:function() {
  return ABP.util.Common.geti18nString('s_dataValidator_presence_message');
}});
Ext.define('ABP.SenchaTextOverrides.data.validator.Range', {override:'Ext.data.validator.Range', getMinOnlyMessage:function() {
...
Ext.define('ABP.SenchaTextOverrides.grid.plugin.DragDrop', {override:'Ext.grid.plugin.DragDrop', bind:{dragText:'{i18n.s_grid_plugin_dragText}'}, setDragText:function(val) {
  this.dragText = val;
}});
Ext.define('ABP.SenchaTextOverrides.view.AbstractView', {override:'Ext.view.AbstractView', bind:{loadingText:'{i18n.s_abstractView_loading}'}, setLoadingText:function(val) {
  this.loadingText = val;
}});
Ext.define('ABP.SenchaTextOverrides.picker.Date', {override:'Ext.picker.Date', beforeRender:function() {
...
Ext.define('ABP.SenchaTextOverrides.picker.Month', {override:'Ext.picker.Month', beforeRender:function() {
...
Ext.define('ABP.SenchaTextOverrides.toolbar.Paging', {override:'Ext.PagingToolbar', bind:{afterPageText:'{i18n.s_toolbar_paging_afterPageText}', displayMsg:'{i18n.s_toolbar_paging_displayMsg}', emptyMsg:'{i18n.s_toolbar_paging_emptyMsg}'}, setAfterPageText:function(val) {
  ...
  return [{itemId:'first', tooltip:ABP.util.Common.geti18nString('s_toolbar_paging_firstText'), overflowText:ABP.util.Common.geti18nString('s_toolbar_paging_firstText'), iconCls:Ext.baseCSSPrefix + 'tbar-page-first', disabled:true, handler:me.moveFirst, scope:me}, {itemId:'prev', tooltip:ABP.util.Common.geti18nString('s_toolbar_paging_prevText'), overflowText:ABP.util.Common.geti18nString('s_toolbar_paging_prevText'), iconCls:Ext.baseCSSPrefix + 'tbar-page-prev', disabled:true, handler:me.movePrevious, 
  scope:me}, '-', ABP.util.Common.geti18nString('s_toolbar_paging_beforePageText'), {xtype:'numberfield', itemId:'inputItem', name:'inputItem', cls:Ext.baseCSSPrefix + 'tbar-page-number', allowDecimals:false, minValue:1, hideTrigger:true, enableKeyEvents:true, keyNavEnabled:false, selectOnFocus:true, submitValue:false, isFormField:false, width:me.inputItemWidth, margin:'-1 2 3 2', listeners:inputListeners}, {xtype:'tbtext', itemId:'afterTextItem', html:Ext.String.format(me.afterPageText, 1)}, '-', 
  {itemId:'next', tooltip:ABP.util.Common.geti18nString('s_toolbar_paging_nextText'), overflowText:ABP.util.Common.geti18nString('s_toolbar_paging_nextText'), iconCls:Ext.baseCSSPrefix + 'tbar-page-next', disabled:true, handler:me.moveNext, scope:me}, {itemId:'last', tooltip:ABP.util.Common.geti18nString('s_toolbar_paging_lastText'), overflowText:ABP.util.Common.geti18nString('s_toolbar_paging_lastText'), iconCls:Ext.baseCSSPrefix + 'tbar-page-last', disabled:true, handler:me.moveLast, scope:me}, 
  '-', {itemId:'refresh', tooltip:ABP.util.Common.geti18nString('s_toolbar_paging_refreshText'), overflowText:ABP.util.Common.geti18nString('s_toolbar_paging_refreshText'), iconCls:Ext.baseCSSPrefix + 'tbar-loading', disabled:me.store.isLoading(), handler:me.doRefresh, scope:me}];
}});
Ext.define('ABP.SenchaTextOverrides.form.Basic', {override:'Ext.form.Basic', bind:{waitTitle:'{i18n.s_form_basic_waitTitle}'}, setWaitTitle:function(val) {
  this.waitTitle = val;
}});
Ext.define('ABP.SenchaTextOverrides.form.field.Base', {override:'Ext.form.field.Base', bind:{invalidText:'{i18n.s_form_field_base_invalidText}'}, setInvalidText:function(val) {
  this.invalidText = val;
}});
Ext.define('ABP.SenchaTextOverrides.form.field.Text', {override:'Ext.form.field.Text', bind:{minLengthText:'{i18n.s_field_text_minLengthText}', maxLengthText:'{i18n.s_field_text_maxLengthText}', blankText:'{i18n.s_field_text_blankText}', regexText:'{i18n.s_field_text_regexText}'}, setMinLengthText:function(val) {
...
Ext.define('ABP.SenchaTextOverrides.form.field.Number', {override:'Ext.form.field.Number', bind:{minText:'{i18n.s_field_number_minText}', maxText:'{i18n.s_field_number_maxText}', nanText:'{i18n.s_field_number_nanText}'}, setMinText:function(val) {
  this.minText = val;
...
Ext.define('ABP.SenchaTextOverrides.form.field.Date', {override:'Ext.form.field.Date', bind:{disabledDaysText:'{i18n.s_field_date_disabledDaysText}', disabledDatesText:'{i18n.s_field_date_disabledDatesText}', minText:'{i18n.s_field_date_minText}', maxText:'{i18n.s_field_date_maxText}', invalidText:'{i18n.s_field_date_invalidText}'}, setDisabledDaysText:function(val) {
...
Ext.define('ABP.SenchaTextOverrides.grid.locking.Lockable', {override:'Ext.grid.locking.Lockable', getMenuItems:function(getMenuItems, locked) {
  var me = this, unlockText = ABP.util.Common.geti18nString('s_grid_header_unlockText'), lockText = ABP.util.Common.geti18nString('s_grid_header_lockText'), unlockCls = Ext.baseCSSPrefix + 'hmenu-unlock', lockCls = Ext.baseCSSPrefix + 'hmenu-lock', unlockHandler = me.onUnlockMenuClick.bind(me), lockHandler = me.onLockMenuClick.bind(me);
  return function() {
...
Ext.define('ABP.SenchaTextOverrides.grid.GroupingFeature', {override:'Ext.grid.feature.Grouping', getMenuItems:function() {
  var me = this, groupByText = ABP.util.Common.geti18nString('s_grid_groupingFeature_groupByText'), disabled = me.disabled || !me.getGroupField(), showGroupsText = ABP.util.Common.geti18nString('s_grid_groupingFeature_showGroupsText'), enableNoGroups = me.enableNoGroups, getMenuItems = me.view.headerCt.getMenuItems;
  return function() {
    var o = getMenuItems.call(this);
...
Ext.define('ABP.SenchaTextOverrides.grid.BooleanColumn', {override:'Ext.grid.BooleanColumn', bind:{trueText:'{i18n.s_grid_booleanColumn_trueText}', falseText:'{i18n.s_grid_booleanColumn_falseText}', undefinedText:'{i18n.s_grid_booleanColumn_undefinedText}'}, setTrueText:function(val) {
  this.trueText = val;
}, setFalseText:function(val) {
  this.falseText = val;
...
Ext.define('ABP.SenchaTextOverrides.form.field.Time', {override:'Ext.form.field.Time', bind:{minText:'{i18n.s_field_time_minText}', maxText:'{i18n.s_field_time_maxText}', invalidText:'{i18n.s_field_time_invalidText}'}, setMinText:function(val) {
  this.minText = val;
}, setMaxText:function(val) {
  this.maxText = val;
}, setInvalidText:function(val) {
...
Ext.define('ABP.SenchaTextOverrides.form.CheckboxGroup', {override:'Ext.form.CheckboxGroup', bind:{blankText:'{i18n.s_field_checkboxGroup_blankText}'}, setBlankText:function(val) {
  this.blankText = val;
}});
Ext.define('ABP.SenchaTextOverrides.form.RadioGroup', {override:'Ext.form.RadioGroup', bind:{blankText:'{i18n.s_field_radioGroup_blankText}'}, setBlankText:function(val) {
  this.blankText = val;
}});
Ext.define('ABP.SenchaTextOverrides.grid.filters.Filters', {override:'Ext.grid.filters.Filters', createMenuItem:function(menu, parentTableId) {
  var me = this, item;
  if (menu.items.length) {
    me.sep = menu.add('-');
  }
  item = menu.add({checked:false, itemId:'filters', text:ABP.util.Common.geti18nString('s_grid_filters_menuFilterText'), listeners:{scope:me, checkchange:me.onCheckChange}});
  return me.filterMenuItem[parentTableId] = item;
}});
Ext.define('ABP.SenchaTextOverrides.grid.filters.filter.Boolean', {override:'Ext.grid.filters.filter.Boolean', createMenu:function(config) {
  var me = this, gId = Ext.id(), listeners = {scope:me, click:me.onClick}, itemDefaults = me.getItemDefaults();
  me.callSuper(arguments);
  me.menu.add([Ext.apply({text:ABP.util.Common.geti18nString('s_grid_filters_boolean_yesText'), filterKey:1, group:gId, checked:!!me.defaultValue, hideOnClick:false, listeners:listeners}, itemDefaults), Ext.apply({text:ABP.util.Common.geti18nString('s_grid_filters_boolean_noText'), filterKey:0, group:gId, checked:!me.defaultValue && me.defaultValue !== null, hideOnClick:false, listeners:listeners}, itemDefaults)]);
}});
Ext.define('ABP.SenchaTextOverrides.grid.filters.filter.List', {override:'Ext.grid.filters.filter.List', bind:{loadingText:'{i18n.s_grid_filters_list_loadingText}'}, setLoadingText:function(val) {
  this.loadingText = val;
}});
Ext.define('ABP.SenchaTextOverrides.grid.filters.filter.Number', {override:'Ext.grid.filters.filter.Number', createMenu:function() {
...
Ext.define('ABP.SenchaTextOverrides.grid.filters.filter.String', {override:'Ext.grid.filters.filter.String', createMenu:function() {
  var me = this, config;
  me.callSuper();
...
Ext.define('ABP.SenchaTextOverrides.view.MultiSelectorSearch', {override:'Ext.view.MultiSelectorSearch', bind:{searchText:'{i18n.s_multiSelectorSearch_searchText}'}, setSearchText:function(val) {
  this.searchText = val;
}});
Ext.define('ABP.SenchaTextOverrides.view.MultiSelector', {override:'Ext.view.MultiSelector', bind:{emptyText:'{i18n.s_multiSelector_emptyText}', removeRowTip:'{i18n.s_multiSelector_removeRowTip}', addToolText:'{i18n.s_multiSelector_addToolText}'}, setEmptyText:function(val) {
  this.emptyText = val;
...
Ext.define('ABP.SenchaTextOverrides.tab.Tab', {override:'Ext.tab.Tab', bind:{closeText:'{i18n.s_tab_closeText}'}, setCloseText:function(val) {
  this.closeText = val;
}});
Ext.define('ABP.Container', {override:'Ext.Container'});
Ext.define('ABP.overrides.loadMask.LoadMask', {override:'Ext.LoadMask', type:3, msg:'', renderTpl:['\x3cdiv id\x3d"{id}-msgWrapEl" data-ref\x3d"msgWrapEl" class\x3d"{[values.$comp.msgWrapCls]}" role\x3d"presentation"\x3e', '\x3cdiv id\x3d"{id}-msgEl" data-ref\x3d"msgEl" class\x3d"{[values.$comp.msgCls]} ', Ext.baseCSSPrefix, 'mask-msg-inner {childElCls}" role\x3d"presentation"\x3e', '\x3ctpl if\x3d"[values.$comp.extraMask]"\x3e', '\x3cdiv id\x3d"{id}-extraEl" data-ref\x3d"extraEl" class\x3d"' + Ext.baseCSSPrefix + 
'mask-extra" role\x3d"presentation"\x3e', '{[values.$comp.extraMask]}', '\x3c/div\x3e', '\x3c/tpl\x3e', '\x3ctpl if\x3d"[values.$comp.msg]"\x3e', '\x3cdiv id\x3d"{id}-msgTextEl" data-ref\x3d"msgTextEl" class\x3d"' + Ext.baseCSSPrefix + 'mask-msg-text {childElCls}" role\x3d"presentation"\x3e', '{msg}', '\x3c/div\x3e', '\x3c/tpl\x3e', '\x3c/div\x3e', '\x3c/div\x3e'], constructor:function(config) {
  config = config || {};
  var msg = '';
...
Ext.define('ABP.form.field.Base', {override:'Ext.form.field.Base', getSubTplData:function(fieldData) {
  var me = this, data = me.callParent(arguments), anchorName = ABP.util.Common.getAutomationClass(me);
  Ext.apply(data, {anchorName:anchorName});
  return data;
}});
Ext.define('ABP.form.field.Text', {override:'Ext.form.field.Text', setVtypeText:function(val) {
  if (val !== undefined) {
    this.vtypeText = val;
  }
}});
Ext.define('ABP.form.field.Checkbox', {override:'Ext.form.field.Checkbox', overCls:Ext.baseCSSPrefix + 'check-over', getSubTplData:function(fieldData) {
  var me = this, data = me.callParent(arguments), anchorCls = data.type === 'checkbox' ? ABP.util.Common.getAutomationClass(me) + '-check' : ABP.util.Common.getAutomationClass(me) + '-' + me.inputValue;
  data['checkboxCls'] = data['checkboxCls'] + ' ' + anchorCls;
  return data;
}});
Ext.define('ABP.form.field.Radio', {override:'Ext.form.field.Radio', overCls:Ext.baseCSSPrefix + 'radio-over'});
Ext.define('ABP.overrides.form.trigger.Spinner', {override:'Ext.form.trigger.Spinner', bodyTpl:'\x3ctpl if\x3d"vertical"\x3e' + '\x3cdiv class\x3d"{spinnerCls} {spinnerCls}-{ui} {spinnerUpCls} {spinnerUpCls}-{ui}' + ' {childElCls} {upDisabledCls} {spinnerUpAutoCls}"\x3e\x3c/div\x3e' + '\x3c/tpl\x3e' + '\x3cdiv class\x3d"{spinnerCls} {spinnerCls}-{ui} {spinnerDownCls} {spinnerDownCls}-{ui}' + ' {childElCls} {downDisabledCls} {spinnerDownAutoCls}"\x3e\x3c/div\x3e' + '\x3ctpl if\x3d"!vertical"\x3e' + 
'\x3cdiv class\x3d"{spinnerCls} {spinnerCls}-{ui} {spinnerUpCls} {spinnerUpCls}-{ui}' + ' {childElCls} {upDisabledCls}"\x3e\x3c/div\x3e' + '\x3c/tpl\x3e', getBodyRenderData:function() {
  var me = this;
  return {vertical:me.vertical, upDisabledCls:me.upEnabled ? '' : me.spinnerUpCls + '-disabled', downDisabledCls:me.downEnabled ? '' : me.spinnerDownCls + '-disabled', spinnerCls:me.spinnerCls, spinnerUpCls:me.spinnerUpCls, spinnerDownCls:me.spinnerDownCls, spinnerUpAutoCls:ABP.util.Common.getAutomationClass(me) + '-spinner-up', spinnerDownAutoCls:ABP.util.Common.getAutomationClass(me) + '-spinner-down'};
}});
Ext.define('ABP.view.BoundList', {override:'Ext.view.BoundList', generateTpl:function() {
  var me = this, displayField = me.displayField, valueField = me.pickerField ? me.pickerField.valueField : displayField, anchorCls = ABP.util.Common.getAutomationClass(me.pickerField || me) + '-picker';
  me.toggleCls(anchorCls, true);
  me.tpl = new Ext.XTemplate('\x3ctpl for\x3d"."\x3e', '\x3cli role\x3d"option" unselectable\x3d"on" class\x3d"' + me.itemCls + ' ', anchorCls + '-item-' + '{' + valueField + ':htmlEncode}', '"\x3e' + me.getInnerTpl(displayField), '\x26nbsp;', '\x3c/li\x3e', '\x3c/tpl\x3e');
}, getInnerTpl:function(displayField) {
  return '{' + displayField + ':htmlEncode}';
}});
Ext.define('ABP.view.Table', {override:'Ext.view.Table', renderRow:function(record, rowIdx, out) {
  var me = this, grid = me.grid, origItemCls = me.itemCls;
...
Ext.define('ABP.grid.column.Column', {override:'Ext.grid.column.Column', constructor:function(config) {
  config = config || {};
...
Ext.define('ABP.view.overrides.PackageEntryOverride', {override:'Ext.package.Entry', count:0, loaded:false, constructor:function(name) {
  ...
  if (ABP.util.Config.getPackageURL() !== null) {
    me.jsUrl = ABP.util.Config.getPackageURL() + '/classic/' + name + '/' + name + '.js';
    me.cssUrl = ABP.util.Config.getPackageURL() + '/classic/' + name + '/' + name + '.css';
  } else {
...
Ext.define('ABP.view.base.popUp.PopUpHeader', {extend:'Ext.container.Container', alias:'widget.popupheader', cls:'abp-popup-header', ui:'popup', layout:{type:'vbox', align:'stretch'}, items:[{xtype:'component', cls:'abp-popup-header-topstrip'}, {xtype:'header', itemId:'abpPanelHeader', cls:'abp-popup-header-header', defaultType:'tool'}], initComponent:function() {
  if (this.title) {
...
Ext.define('ABP.view.base.popUp.PopUp', {extend:'Ext.panel.Panel', singleton:true, requires:['ABP.view.base.popUp.PopUpController', 'ABP.view.base.popUp.PopUpHeader', 'ABPControlSet.util.Markdown'], alias:'widget.abppopup', alternateClassName:'ABP.Popup', controller:'abppopupcontroller', header:{xtype:'popupheader'}, layout:{type:'hbox', align:'center', pack:'start'}, floating:true, centered:true, modal:true, cls:'framePop', ui:'popup', sizingConstants:{minWidth:440, minHeight:185, maxWidth:760}, 
minHeight:185, shadow:false, config:{closeKeymap:undefined}, ariaRole:'alertdialog', ariaDescribedBy:'errorPopMessage', ariaAttributes:{'aria-modal':'true'}, dockedItems:[{xtype:'container', dock:'bottom', itemId:'errorPopButtonBar', cls:'errorpop-buttonbar', layout:{type:'hbox', pack:'end'}, items:[{xtype:'button', frame:false, width:100, bind:{text:'{i18n.error_ok_btn:htmlEncode}', ariaLabel:'{i18n.error_ok_btn:htmlEncode}'}, handler:function() {
  this.up('abppopup').hidePopup();
}}]}], items:[{xtype:'component', itemId:'errorPopIcon', cls:'popIcon', flex:1, html:'\x3ci class\x3d"icon-window-warning"\x3e\x3c/i\x3e'}, {xtype:'component', id:'errorPopMessage', cls:'errorpop-message', ariaRole:'alert', ariaAttributes:{'aria-live':'polite'}, flex:7, width:'100%', scrollable:'y', html:''}], __showPopup:function(message, title, icon, buttonConfig, closeCallback, options) {
  var me = this;
  options = options || {};
  ...
  return [{xtype:'button', frame:false, minWidth:100, automationCls:'popup-btn-ok', defaultFocus:true, bind:{text:'{i18n.error_ok_btn:htmlEncode}'}, handler:function() {
    this.up('abppopup').hidePopup();
  }}];
  ...
  if (Ext.isArray(buttonConfig)) {
    for (i = 0; i < buttonConfig.length; ++i) {
      if (buttonConfig[i].text) {
        ...
        ret.push({xtype:'button', frame:false, minWidth:100, defaultFocus:buttonConfig[i].defaultFocus, args:buttonConfig[i].args, text:Ext.String.htmlEncode(buttonText), automationCls:'popup-btn-' + i, handler:function() {
    ...
    if (buttonConfig.text) {
      ...
      ret.push({xtype:'button', frame:false, minWidth:100, defaultFocus:buttonConfig.defaultFocus, args:buttonConfig.args, text:Ext.String.htmlEncode(buttonText), handler:function() {
        this.up('abppopup').hidePopup(this.args);
      }});
    }
  }
  ...
  if (hidden) {
    ...
    var size = text.length * 7 + 120;
    var largestSize = 10500;
    var smallestSize = 325;
    if (size < largestSize) {
...
Ext.define('ABP.view.base.toast.ABPToast', {extend:'ABP.view.base.toast.ToastBase', singleton:true, requires:['ABPControlSet.util.Markdown'], show:function(message, level, iconCls, placement, handler, handlerArgs, isMarkdown) {
  var me = this;
  ...
  var toast = Ext.toast({ariaRole:'alert', ariaAttributes:{'aria-live':ariaLive}, html:me.makeHtml(config), autoCloseDelay:config.duration, maxWidth:ABP.util.Common.getWindowWidth() * 0.8, align:config.placement, closable:false, shadow:true, listeners:{click:{element:'el', fn:onclick}}, handler:config.handler, handlerArgs:config.handlerArgs, cls:['abp-toast', 'abp-toast-' + levelMap], getXposAlignedToAnchor:function() {
  ...
  var messageText = config.isMarkdown ? ABPControlSet.util.Markdown.parseMarkdown(config.message) : Ext.htmlEncode(config.message);
  return "\x3cdiv style\x3d'display: flex;' class\x3d'abp-toast-inner-" + this.getLevel(config.level) + "'\x3e" + "\x3cdiv class\x3d'abp-toast-icon-block " + Ext.htmlEncode(config.iconCls) + "'\x3e\x3c/div\x3e" + "\x3cdiv class\x3d'abp-toast-message'\x3e" + messageText + '\x3c/div\x3e' + '\x3c/div\x3e';
}}}, function(ABPToast) {
  ABP.toast = function(message, level, iconCls, placement, handler, handlerArgs, isMarkdown) {
    return ABP.view.base.toast.ABPToast.show(message, level, iconCls, placement, handler, handlerArgs, isMarkdown);
  };
});
Ext.define('ABP.view.base.automation.AutomationHintOverlay', {extend:'Ext.panel.Panel', singleton:true, alias:'widget.automationoverlay', layout:{type:'absolute'}, floating:true, centered:true, items:[], cls:'automation-overlay', overlayTip:undefined, toggle:function() {
  if (this.isVisible()) {
    this.hideOverlay();
  } else {
    this.showOverlay();
  ...
  var i;
  if (!this.overlayTip) {
    overlayTip = Ext.create('Ext.tip.ToolTip', {target:this.getEl(), delegate:'div[autolabel]', trackMouse:true, renderTo:Ext.getBody(), listeners:{beforeshow:function updateTipBody(tip) {
  ...
  function createRegion(el, label) {
    ...
    return {xtype:'component', cls:'automation-hint', x:elPos.left, y:elPos.top, width:el.offsetWidth, height:el.offsetHeight, html:label, autoEl:{tag:'div', autolabel:label}, listeners:{el:{mouseover:me.highlightElement, mouseleave:me.removeElementHighlight}}};
  }
...
Ext.define('ABP.view.launch.loading.LoadingScreen', {extend:'Ext.container.Container', alias:'widget.apteanloadingscreen', componentCls:'launch-canvas', layout:{type:'vbox', align:'center', pack:'center'}, initComponent:function() {
...
Ext.define('ABP.view.session.offline.PasswordPrompt', {extend:'Ext.panel.Panel', requires:['ABP.view.session.offline.PasswordPromptController'], alias:'widget.passwordprompt', controller:'passwordprompt', layout:{type:'vbox', align:'center', pack:'center'}, floating:true, cls:'favoriteseditpanel', bodyCls:'x-unselectable', floating:true, modal:true, bind:{title:'{i18n.offline_promptpassword_title:htmlEncode}'}, width:275, shadow:false, items:[{xtype:'textfield', width:250, allowBlank:false, itemId:'password', 
inputType:'password', labelAlign:'top', bind:{fieldLabel:'{i18n.offline_password_prompt:htmlEncode}'}, keyMap:{'ENTER':{handler:'onOkClicked'}}}], bbar:{defaults:{border:false}, items:['-\x3e', {bind:{text:'{i18n.button_cancel:htmlEncode}'}, automationCls:'offline-passwordPrompt-cancel', width:100, handler:'onCancelClicked'}, {bind:{text:'{i18n.button_OK:htmlEncode}'}, automationCls:'offline-passwordPrompt-ok', width:100, handler:'onOkClicked'}]}});
...
Ext.define('ABP.view.launch.login.Login', {extend:'Ext.panel.Panel', requires:['ABP.view.launch.login.LoginController', 'ABP.view.launch.login.LoginModel'], alias:'widget.login', controller:'logincontroller', viewModel:{type:'loginmodel'}, scrollable:{y:true, x:false}, flex:1, listeners:{scope:'controller', boxready:'onBoxready', tabchanged:'onTabChanged'}, cls:'main-content-wrapper', items:[{xtype:'container', cls:'main-content', width:'100%', layout:{type:'vbox', align:'middle', pack:'start'}, 
defaults:{labelAlign:'top', msgTarget:'none'}, defaultType:'abptext', items:[{width:'100%', itemId:'username', reference:'usernameField', allowBlank:false, bind:{value:'{username}', disabled:'{preauthenticated}', fieldLabel:'{i18n.login_username:htmlEncode}', hidden:'{!showUsernameField}'}, tabIndex:1, listeners:{specialkey:function(f, e) {
  if (e.getKey() === e.ENTER) {
    f.fireEvent('login_UserHit');
  }
}, scope:this}, automationCls:'login-username', spellcheck:false, inputAttrTpl:['autocapitalize\x3d"off" automationId\x3d"loginUsername"']}, {width:'100%', itemId:'password', reference:'passwordField', inputType:'password', tabIndex:2, allowBlank:false, bind:{value:'{password}', hidden:'{!showPasswordField}', fieldLabel:'{passwordText:htmlEncode}'}, automationCls:'login-password', inputAttrTpl:['automationId\x3d"loginPassword"'], listeners:{specialkey:function(f, e) {
  if (e.getKey() === e.ENTER) {
    f.blur();
    f.fireEvent('login_PassHit');
  }
}, scope:this}, focusable:true}, {xtype:'combo', width:'100%', itemId:'login-environment', listConfig:{cls:'abp-login-combo a-environment-options a-combo-' + Ext.os.deviceType}, bind:{store:'{main_environmentStore}', value:'{environment}', selection:'{env_selection}', fieldLabel:'{i18n.login_environment:htmlEncode}', hidden:'{hideEnvironment}'}, triggerAction:'all', cls:'launch-combo-box top-combo-box a-environment-combo', queryMode:'local', editable:false, forceSelection:true, displayField:'name', 
valueField:'id', tabIndex:3, autoSelect:true, focusable:true, listeners:{change:function(me, newVal) {
  me.fireEvent('login_environmentChanged', newVal);
}, scope:this}, shadow:'sides'}, {xtype:'combo', width:'100%', itemId:'login-language', bind:{store:'{login_settingsStore}', selection:'{lan_selection}', fieldLabel:'{i18n.login_language:htmlEncode}', value:'{language}', hidden:'{hideLanguage}'}, listConfig:{cls:'abp-login-combo a-language-options a-combo-' + Ext.os.deviceType}, triggerAction:'all', cls:'launch-combo-box a-language-combo', queryMode:'local', editable:false, forceSelection:true, displayField:'name', valueField:'key', tabIndex:4, autoSelect:true, 
visible:false}, {xtype:'container', width:'100%', layout:'vbox', itemId:'loginExtraFieldCont', items:[], bind:{items:'{extraLoginFields}'}, setItems:function(newItems) {
  Ext.suspendLayouts();
  this.removeAll();
  this.add(newItems);
  Ext.resumeLayouts(true);
}}]}, {xtype:'container', cls:'main-content-footer', width:'100%', layout:{type:'vbox', align:'middle', pack:'start'}, items:[{xtype:'button', itemId:'loginButton', width:'100%', bind:{text:'{loginBtnText:htmlEncode}'}, cls:'btn-login a-login-button', flex:1, tabIndex:5, height:40, frame:false, handler:'loginButtonClick', focusable:true}, {xtype:'button', cls:'login-keepme a-keepme-button', itemId:'loginKeepMe', bind:{text:'{i18n.login_keepMeSignedIn:htmlEncode}', iconCls:'{keepMeSignedInIcon}', 
hidden:'{!canKeepMeSignedIn}'}, handler:'keepMeSignedInClicked', tabIndex:6}, {xtype:'button', cls:'login-forgotpassword a-forgot-password', itemId:'forgotpassword-label', bind:{html:'{i18n.login_forgotpassword:htmlEncode}', visible:'{canRecoverPassword}', focusable:'{canRecoverPassword}'}, tabIndex:7, frame:false, textAlign:'center', listeners:{click:'onForgotPasswordClick'}, setFocusable:function(setVal) {
  this.focusable = setVal;
}}, {xtype:'button', itemId:'settingsButton', cls:'login-settings a-login-settings', iconCls:'icon-gearwheel', tabIndex:8, frame:false, ariaLabel:'settings', handler:'onSettingsClick', focusable:true, bind:{visible:'{allowServiceChange}'}}]}]});
Ext.define('ABP.view.base.popUp.PopUpFrame', {extend:'Ext.panel.Panel', alias:'widget.popupframe', requires:['ABP.view.base.popUp.PopUpHeader'], floating:true, centered:true, modal:true, cls:'framePop', ui:'popup', width:'50%', minHeight:200, shadow:false, header:{xtype:'popupheader'}, dockedItems:[{xtype:'container', dock:'bottom', itemId:'errorPopButtonBar', cls:'errorpop-buttonbar', layout:{type:'hbox', pack:'end'}, items:[{xtype:'button', frame:false, width:100, bind:{text:'{i18n.login_save:htmlEncode}'}, 
handler:function() {
...
}}, {xtype:'button', frame:false, width:100, cls:'abp-popup-button', bind:{text:'{i18n.button_close:htmlEncode}'}, handler:function() {
  this.up('popupframe').closePopup();
}}]}], initComponent:function() {
  if (this.config && this.config.buttonInfo) {
    if (this.config.buttonInfo.contentXtype) {
      this.items = [{xtype:this.config.buttonInfo.contentXtype, padding:10}];
    }
...
Ext.define('ABP.view.launch.settings.Settings', {extend:'Ext.panel.Panel', requires:['ABP.view.launch.settings.SettingsController', 'ABP.view.launch.settings.SettingsModel', 'ABP.view.base.popUp.PopUpFrame', 'Ext.panel.Panel', 'Ext.form.field.ComboBox'], alias:'widget.settings', controller:'settingscontroller', viewModel:{type:'settingsmodel'}, defaultType:'textfield', stores:['SettingsLanguageStore'], models:['SettingsLanguageModel'], cls:'main-content-wrapper', items:[{xtype:'container', cls:'main-content', 
layout:{type:'vbox', align:'middle'}, height:'100%', width:'100%', items:[{xtype:'abpheadercomponent', cls:'settings-title', width:'100%', componentCls:'x-unselectable', bind:{html:'{i18n.login_settingsTitle:htmlEncode}'}}, {xtype:'component', itemId:'settingsGuide', width:'100%', ariaRole:'status', componentCls:'settings-text x-unselectable', bind:{html:'{i18n.login_settingsInstructions:htmlEncode}'}}, {xtype:'label', align:'middle', width:'100%', itemId:'settingsErrorLabel', cls:'error-label error-label-hide', 
text:'INVALID URL'}, {xtype:'combo', width:'100%', labelAlign:'top', itemId:'url', bind:{fieldLabel:'{i18n.login_url:htmlEncode}', store:'{serverUrlStore}'}, displayField:'url', valueField:'url', queryMode:'local', listConfig:{itemTpl:['\x3cdiv class\x3d"server-url a-server-url" data-qtip\x3d"{url}"\x3e{url}\x3c/div\x3e', '\x3cdiv class\x3d"delete-item" role\x3d"button" aria-label\x3d"Remove URL" title\x3d"Remove URL"\x3e', '\x3cspan class\x3d"delete-item-icon icon-garbage-can"\x3e\x3c/span\x3e\x3c/div\x3e'], 
listeners:{itemclick:function(view, record, item, index, e, eOpts) {
  ...
  return true;
}}}}, {xtype:'container', layout:'vbox', itemId:'settingsExtraFieldCont', items:[], width:'100%', bind:{items:'{extraSettingsFields}'}, setItems:function(newItems) {
  Ext.suspendLayouts();
  this.removeAll();
  this.add(newItems);
  Ext.resumeLayouts(true);
}}]}, {xtype:'container', cls:'main-content-footer buttons', items:[{xtype:'button', reference:'backButton', componentCls:'btn-login a-settings-back', handler:'backButtonClick', width:'49%', bind:{visible:'{bootstrapped}', text:'{i18n.login_back:htmlEncode}'}}, {xtype:'button', itemId:'saveButton', componentCls:'btn-login a-settings-save', handler:'saveButtonClick', bind:{width:'{saveButtonWidth}', text:'{i18n.login_save:htmlEncode}'}}]}], initComponent:function() {
  var me = this;
  me.callParent();
...
Ext.define('ABP.view.launch.maintenance.RecoverPassword', {extend:'Ext.panel.Panel', requires:['Ext.form.field.ComboBox', 'ABP.view.launch.maintenance.RecoverPasswordController', 'ABP.view.launch.maintenance.RecoverPasswordModel'], alias:'widget.recoverpassword', controller:'recoverpassword', viewModel:{type:'recoverpassword'}, cls:'main-content-wrapper', items:[{xtype:'container', cls:'main-content', defaults:{align:'middle', labelAlign:'top'}, layout:{type:'vbox', pack:'start'}, height:'100%', 
width:'100%', items:[{xtype:'abpheadercomponent', width:'100%', cls:'settings-title', bind:{html:'{i18n.login_recoverTitle:htmlEncode}'}}, {xtype:'component', width:'100%', itemId:'settingsGuide', ariaRole:'status', componentCls:'settings-text x-unselectable', bind:{html:'{i18n.login_recoverInstructions:htmlEncode}'}}, {xtype:'textfield', align:'middle', width:'100%', bind:{value:'{recover_id}', fieldLabel:'{i18n.login_recover_id:htmlEncode}'}, itemId:'recUrl', reference:'recoverPasswordId', value:'', 
requiredCls:'login-required-field', msgTarget:'side', cls:'x-unselectable a-recoverpw-userid', listeners:{specialkey:function(f, e) {
  if (e.getKey() === e.ENTER) {
    f.blur();
    f.fireEvent('recoverpw_Send');
  }
}}}, {xtype:'combo', itemId:'rec-environment-combo', width:'100%', bind:{store:'{main_environmentStore}', value:'{environment}', selection:'{env_selection}', fieldLabel:'{i18n.login_environment:htmlEncode}'}, triggerAction:'all', requiredCls:'login-required-field', cls:'launch-combo-box top-combo-box a-recoverpw-environment', listConfig:{cls:'abp-login-combo a-recoverpassword-options', shadow:false}, queryMode:'local', editable:false, forceSelection:true, displayField:'name', valueField:'id', autoSelect:true, 
focusable:true, listeners:{change:function(me, newVal) {
  me.fireEvent('login_environmentChanged', newVal);
}, scope:this}}]}, {xtype:'container', cls:'main-content-footer buttons', items:[{xtype:'button', reference:'recBackButton', componentCls:'btn-login a-recoverpw-back', handler:'backButtonClick', width:'49%', bind:{text:'{i18n.login_recover_back:htmlEncode}'}}, {xtype:'button', itemId:'recSendButton', componentCls:'btn-login a-recoverpw-send', handler:'sendButtonClick', width:'49%', bind:{text:'{i18n.login_recover_send:htmlEncode}'}}]}], afterRender:function() {
  var me = this;
...
Ext.define('ABP.view.launch.maintenance.ForcePassword', {extend:'Ext.panel.Panel', requires:['Ext.panel.Panel', 'Ext.form.field.ComboBox', 'ABP.view.launch.maintenance.ForcePasswordController', 'ABP.view.launch.maintenance.ForcePasswordModel'], alias:'widget.forcepassword', defaultType:'textfield', controller:'forcepassword', viewModel:{type:'forcepassword'}, tabIndex:-1, cls:'main-content-wrapper', items:[{xtype:'container', cls:'main-content', layout:{type:'vbox', align:'middle', pack:'start'}, 
defaults:{labelAlign:'top'}, height:'100%', width:'100%', items:[{xtype:'component', cls:'settings-title', width:'100%', bind:{html:'{i18n.login_forcepw_title:htmlEncode}'}, tabIndex:-1}, {xtype:'component', itemId:'forcepwGuide', width:'100%', componentCls:'settings-text x-unselectable', bind:{html:'{i18n.login_forcepw_instructions:htmlEncode}'}, tabIndex:-1}, {xtype:'textfield', align:'middle', width:'100%', bind:{value:'{newPassword}', fieldLabel:'{i18n.login_forcepw_newPassword:htmlEncode}'}, 
inputType:'password', itemId:'newPassword', labelWidth:0, value:'', cls:'x-unselectable login-required-field a-forcechange-newpassword', tabIndex:1}, {xtype:'textfield', align:'middle', width:'100%', bind:{value:'{confirmPassword}', fieldLabel:'{i18n.login_forcepw_confirmPassword:htmlEncode}'}, inputType:'password', itemId:'confirmPassword', labelWidth:0, value:'', cls:'x-unselectable login-required-field a-forcechange-confirmpassword', tabIndex:2, listeners:{specialkey:function(f, e) {
  if (e.getKey() === e.ENTER) {
    f.blur();
    f.fireEvent('forcepw_Signin');
  }
}}}]}, {xtype:'container', cls:'main-content-footer buttons', items:[{xtype:'button', itemId:'forceBackButton', componentCls:'btn-login a-forcechange-back', width:'49%', handler:'backButtonClick', bind:{text:'{i18n.login_forcepw_back:htmlEncode}'}}, {xtype:'button', itemId:'forceSignInButton', componentCls:'btn-login a-forcechange-signin', handler:'signInButtonClick', width:'49%', bind:{text:'{i18n.login_forcepw_signIn:htmlEncode}'}}]}]});
Ext.define('ABP.view.launch.maintenance.ExtraStep', {extend:'Ext.container.Container', requires:['ABP.view.launch.settings.ExtraStepController'], alias:'widget.maintenanceextrastep', controller:'extrastepcontroller', cls:'main-content-wrapper', initItems:function() {
  ...
  this.callParent();
}, items:[{xtype:'container', cls:'main-content', layout:{type:'vbox', align:'middle', pack:'start'}, width:'100%', defaults:{width:'100%'}, items:[], itemId:'ABPExtraStepCustomContainer'}, {xtype:'container', cls:'main-content-footer buttons', items:[{xtype:'button', reference:'backButton', componentCls:'btn-login a-extrastep-back', width:'49%', handler:'backButtonClick', bind:{text:'{i18n.login_back:htmlEncode}'}}, {xtype:'button', itemId:'saveButton', width:'49%', componentCls:'btn-login a-extrastep-save', 
handler:'continueButtonClick', bind:{text:'{i18n.button_continue:htmlEncode}'}}]}]});
...
{xtype:'textfield', width:'100%', labelAlign:'top', reference:'offlinepassword', inputType:'password', allowBlank:false, tabIndex:2, bind:{fieldLabel:'{i18n.offline_login_password:htmlEncode}'}, automationCls:'offline-login-password', inputAttrTpl:['automationId\x3d"offlineLoginPassword"'], focusable:true}, {xtype:'textfield', width:'100%', labelAlign:'top', reference:'confirmofflinepassword', inputType:'password', allowBlank:false, tabIndex:2, bind:{fieldLabel:'{i18n.offline_login_confirmpassword:htmlEncode}'}, 
automationCls:'offline-login-confirmpassword', inputAttrTpl:['automationId\x3d"confirmofflineLoginPassword"'], listeners:{specialkey:function(f, e) {
  if (e.getKey() === e.ENTER) {
...
Ext.define('ABP.view.launch.maintenance.Maintenance', {extend:'Ext.container.Container', requires:['ABP.view.launch.maintenance.RecoverPassword', 'ABP.view.launch.maintenance.ForcePassword', 'ABP.view.launch.maintenance.ExtraStep', 'ABP.view.launch.maintenance.OfflinePassword'], alias:'widget.maintenance', layout:{type:'fit'}, items:[], showScreen:function(xtypeToShow, additionalStepInfo) {
...
Ext.define('ABP.view.launch.selectuser.SelectUser', {extend:'Ext.container.Container', requires:['ABP.view.launch.selectuser.SelectUserController', 'ABP.view.launch.selectuser.SelectUserModel', 'ABP.view.base.popUp.PopUpFrame', 'Ext.panel.Panel', 'Ext.form.field.ComboBox'], alias:'widget.selectuser', controller:'selectusercontroller', viewModel:{type:'selectusermodel'}, height:'100%', layout:{type:'vbox', align:'middle'}, defaultFocus:'userList', initFocus:function() {
  var me = this, vm = me.getViewModel(), user = vm.get('selectedUser');
  if (user) {
...
}, items:[{xtype:'abpheadercomponent', cls:'settings-title', reference:'login-selectuser-title', width:250, componentCls:'x-unselectable', bind:{html:'{i18n.login_selectUserTitle:htmlEncode}'}, tabIndex:-1}, {xtype:'component', itemId:'selectUserGuide', reference:'login-selectuser-desc', width:250, componentCls:'settings-text x-unselectable', bind:{html:'{i18n.login_selectUserInstructions:htmlEncode}'}, tabIndex:-1}, {layout:'fit', width:250, height:280, xtype:'dataview', itemId:'userList', reference:'userList', 
cls:'selectuser-userList a-selectuser-userList', overItemCls:Ext.baseCSSPrefix + 'grid-item-over', selectedItemCls:Ext.baseCSSPrefix + 'grid-item-selected', bind:{store:'{userStore}', selection:'{selectedUser}'}, scrollable:true, ariaLabelledBy:'login-selectuser-title', ariaDescribedBy:'login-selectuser-desc', itemSelector:'li.selectuser-item', tpl:['\x3cul class\x3d"selectuser-items" role\x3d"list"\x3e', '\x3ctpl for\x3d"."\x3e', '\x3cli class\x3d"selectuser-item" role\x3d"listitem"\x3e', '\x3cdiv class\x3d"selectuser-image"\x3e\x3cspan class\x3d"selectuser-image-icon {useAnotherUser:this.getClass(values.data)}" style\x3d"{data:this.getPhoto()}"\x3e\x3c/span\x3e\x3c/div\x3e', 
...
'\x3c/tpl\x3e', '\x3c/li\x3e', '\x3c/tpl\x3e', '\x3c/ul\x3e', {getClass:function(useAnotherUser, data) {
  if (useAnotherUser) {
...
Ext.define('ABP.view.launch.LaunchCarousel', {extend:'Ext.tab.Panel', requires:['ABP.view.launch.LaunchCarouselController', 'ABP.view.launch.LaunchCarouselModel'], alias:'widget.launchcarousel', controller:'launchcarouselcontroller', viewModel:'launchcarouselmodel', tabBar:{hidden:true}, listeners:{'afterRender':function(tabPanel) {
  var me = tabPanel;
  var vm = me.getViewModel();
  var startingLaunchCarouselTab = vm.get('startingLaunchCarouselTab');
  tabPanel.setActiveTab(startingLaunchCarouselTab);
}}});
Ext.define('ABP.view.launch.discovery.Discovery', {extend:'Ext.panel.Panel', requires:['ABP.view.launch.discovery.DiscoveryController', 'ABP.view.launch.discovery.DiscoveryModel'], alias:'widget.discovery', controller:'discoverycontroller', viewModel:{type:'discoverymodel'}, scrollable:{y:true, x:false}, flex:1, listeners:{scope:'controller', boxready:'onBoxready'}, cls:'main-content-wrapper', items:[{xtype:'container', cls:'main-content', width:'100%', layout:{type:'vbox', align:'middle', pack:'start'}, 
defaults:{labelAlign:'top', msgTarget:'none'}, defaultType:'abptext', items:[{type:'component', margin:'0 0 20 0', bind:{html:'{i18n.login_SSOHelp:htmlEncode}'}}, {width:'100%', itemId:'email', reference:'emailField', tabIndex:1, bind:{value:'{email}', fieldLabel:'{i18n.login_emailOrOrganisation:htmlEncode}'}, listeners:{specialkey:'handleSpecialKeys'}, automationCls:'login-email', allowBlank:false, spellcheck:false, focusable:true, inputAttrTpl:['autocapitalize\x3d"off" automationId\x3d"loginEmail"']}, 
{xtype:'label', itemId:'errorText', padding:4, bind:{html:'{errorText}'}}]}, {xtype:'container', cls:'main-content-footer', width:'100%', layout:{type:'vbox', align:'middle', pack:'start'}, items:[{xtype:'button', itemId:'loginButton', width:'100%', bind:{text:'{i18n.button_next:htmlEncode}'}, cls:'btn-login a-login-button', flex:1, tabIndex:5, height:40, frame:false, handler:'loginButtonClick', focusable:true}]}]});
Ext.define('ABP.view.launch.LaunchCanvas', {extend:'Ext.panel.Panel', alias:'widget.launchcanvas', requires:['ABP.view.session.SessionBanner', 'ABP.view.launch.login.Login', 'ABP.view.launch.settings.Settings', 'ABP.view.launch.maintenance.Maintenance', 'ABP.view.launch.selectuser.SelectUser', 'ABP.view.launch.LaunchCarousel', 'ABP.view.launch.discovery.Discovery'], itemId:'launch-canvas', componentCls:'launch-canvas', cls:'launch-canvas', tbar:{xtype:'sessionbanner', ariaAttributes:{'aria-label':'Headline Message'}, 
dock:'top'}, layout:{type:'vbox', align:'center', pack:'center'}, initComponent:function() {
  this.items = [{xtype:'container', componentCls:'login-form', width:380, minHeight:600, maxHeight:600, layout:{type:'vbox', align:'stretch', pack:'start'}, items:[{xtype:'abpheadercomponent', cls:'login-hdr-wrapper', itemId:'login-title', ariaAttributes:{'aria-level':'1'}, bind:{html:'\x3cdiv class\x3d"login-hdr"\x3e{i18n.login_login_header:htmlEncode}\x3c/div\x3e'}, width:380, tabIndex:-1, focusable:false}, {xtype:'launchcarousel', padding:'0 0 24 0', minHeight:350, flex:1, items:[{title:'settings', 
  xtype:'settings', itemId:'settings-tab', defaults:{padding:'0 24 0 24'}}, {title:'login', xtype:'login', itemId:'login-tab', defaults:{padding:'0 44 0 44'}}, {title:'maintenance', xtype:'maintenance', itemId:'maintenance-tab', defaults:{padding:'0 24 0 24'}}, {title:'selectuser', xtype:'selectuser', itemId:'selectuser-tab'}, {title:'discovery', xtype:'discovery', itemId:'discovery-tab', defaults:{padding:'0 44 0 44'}}]}]}];
  this.callParent();
}});
...
Ext.define('ABP.view.session.notifications.NotificationController', {extend:'ABP.view.session.notifications.NotificationBaseController', alias:'controller.abp-notification', handleNotificationKeyDown:function(evt, cmp) {
...
}, cls:'abp-notification', layout:'card', listeners:{keydown:{element:Ext.isModern ? 'element' : 'el', fn:'handleNotificationKeyDown'}}, items:[{xtype:'container', reference:'notificationDisplayContainer', frame:false, layout:{type:'vbox', align:'stretch'}, items:[{xtype:'component', itemId:'notificationSpecificNavComponent', reference:'notificationSpecificNavComponent', bind:{ariaLabel:'{totalNotificationCount} {notificationLabel:ariaEncode} {notificationDetail} {notificationAdditionalAriaDetail}'}, 
tabIndex:-1, focusable:true}, {xtype:'container', frame:false, cls:'abp-notification-header', layout:{type:'hbox'}, items:[{xtype:'button', reference:'notificationLinkButton', cls:'abp-notification-link a-abp-notification-link', uiCls:'abp-link', textAlign:'left', flex:1, tabIndex:0, bind:{text:'{notificationLabel:htmlEncode}', ariaLabel:'{notificationLabel:ariaEncode}'}, handler:'onNotificationLinkClick'}, {xtype:'button', reference:'notificationReadButton', cls:'abp-notification-read-button a-abp-notification-read-button', 
iconCls:'icon-navigate-cross', ariaLabel:'Mark Read', handler:'onNotificationMarkReadClick'}]}, {xtype:'component', cls:'abp-notification-detail x-unselectable', bind:{html:'{notificationDetail:htmlEncode}'}}, {xtype:'toolbar', cls:'abp-notification-toolbar', items:[{xtype:'component', reference:'notificationToolbarLabel', cls:'abp-notification-toolbar-label'}, '-\x3e', {xtype:'container', cls:'abp-notification-toolbar-buttons-wrapper', items:[{xtype:'button', reference:'notificationDownloadButton', 
cls:'abp-notification-download-button a-abp-notification-download-button', iconCls:'icon-cloud-download', ariaLabel:'Download', handler:'onNotificationDownloadClick', hidden:true}, {xtype:'button', reference:'notificationFlagButton', cls:'abp-notification-flag-button a-abp-notification-flag-button', iconCls:'icon-signal-flag', ariaLabel:'Flag', enableToggle:true, handler:'onNotificationFlagClick'}, {xtype:'button', reference:'notificationUnreadButton', cls:'abp-notification-unread-button a-abp-notification-unread-button', 
iconCls:'icon-nav-undo', ariaLabel:'Mark Unread', handler:'onNotificationMarkUnreadClick'}, {xtype:'button', reference:'notificationRemoveButton', cls:'abp-notification-remove-button a-abp-notification-remove-button', iconCls:'icon-garbage-can', ariaLabel:'Delete', handler:'onNotificationRemoveClick'}]}]}]}, {xtype:'container', reference:'notificationMarkedAsReadContainer', layout:{type:'vbox', align:'center', pack:'center'}, items:[{xtype:'component', cls:'abp-notification-action-label icon-fa-check-circle-o-01', 
bind:{html:'{i18n.abp_notifications_label_marked_as_read:htmlEncode}'}}]}, {xtype:'container', reference:'notificationMarkedAsUnreadContainer', layout:{type:'vbox', align:'center', pack:'center'}, items:[{xtype:'component', cls:'abp-notification-action-label icon-nav-undo', bind:{html:'{i18n.abp_notifications_label_marked_as_unread:htmlEncode}'}}]}, {xtype:'container', reference:'notificationRemovedContainer', layout:{type:'vbox', align:'center', pack:'center'}, items:[{xtype:'component', cls:'abp-notification-action-label icon-garbage-can', 
bind:{html:'{i18n.abp_notifications_label_removed:htmlEncode}'}}]}], initComponent:function() {
...
Ext.define('ABP.view.main.ABPMain', {extend:'Ext.container.Container', xtype:'app-main', requires:['ABP.view.main.ABPMainModel', 'ABP.view.main.ABPMainController', 'ABP.view.launch.loading.Loading'], controller:'abpmaincontroller', viewModel:'abpmainmodel', layout:{type:'fit'}, items:[{xtype:'loadingscreen'}], listeners:{click:{element:'el', fn:function() {
  ABP.util.Common.setKeyboardNavigation(false);
}}}});
Ext.define('ABP.view.main.ABPMain', {extend:'Ext.Container', controller:'abpmaincontroller', viewModel:{type:'abpmainmodel'}, xtype:'app-main', items:[{xtype:'login'}]});
Ext.define('ABP.view.base.components.ExpandPanel', {extend:'Ext.window.Window', requires:['ABP.view.base.components.ExpandPanelViewModel'], alias:'widget.abpexpandpanel', cls:'baseexpandpanel', bodyCls:'x-unselectable', floating:true, modal:true, config:{parentComponent:undefined, desiredWidth:500, desiredHeight:400, closeKeymap:undefined, fullscreenContainer:undefined, fullscreen:false}, bumper:20, animationDuration:250, origin:{x:0, y:0, height:100, width:100}, tools:[], listeners:{beforeclose:function() {
  var me = this;
  if (me.waitForAnimation) {
    ...
    me.animate({duration:me.animationDuration, to:{x:pos[0], y:pos[1], width:size.width, height:size.height}, callback:function() {
  ...
  me.animate({duration:me.animationDuration, to:to});
}, privates:{waitForAnimation:true, monitoringResize:false, updateFullscreen:function(newValue, oldvalue) {
  var me = this;
  if (newValue) {
    me.setMaxWidth(null);
  ...
  var to = {x:Math.ceil((maxSize.width - newWidth) / 2), y:Math.ceil((maxSize.height - newHeight) / 2), width:newWidth, height:newHeight};
  if (me.fullscreen) {
  ...
  var me = this;
  var to = me.getTargetTo();
  me.animate({duration:me.animationDuration / 2, to:to});
}}});
Ext.define('ABP.view.base.rightpane.RightPanePanel', {extend:'Ext.panel.Panel', alias:'widget.baserightpanepanel', cls:'abp-right-panel', header:{title:{ariaRole:'header', ariaAttributes:{'aria-level':'3'}}}, scrollable:'vertical', focusableContainer:true, activeMenuButton:null, initComponent:function() {
  var me = this;
  var closeTooltip = ABP.util.Common.geti18nString('button_close');
  me.tools = (me.tools || []).concat([{type:'close', automationCls:'rightpanel-btn-close', handler:'baseRightPanePanel_toggleRightPane', tooltip:closeTooltip}]);
  this.callParent();
...
Ext.define('ABP.view.buttons.BadgeButton', {extend:'Ext.button.Button', xtype:'abpbadgebutton', config:{badgeValue:null, badgePriority:ABP.util.Constants.badgePriority.Info}, __delayedTaskUpdateBadge:null, childEls:['badgeEl'], getTemplateArgs:function() {
  var values = this.callParent(arguments);
  var me = this, badgeData = me.getBadgeData();
  Ext.apply(values, badgeData);
  return values;
}, getBadgeData:function() {
  var me = this;
  return {badgeValue:me.getBadgeValue(), badgePriority:me.getBadgePriority()};
}, renderTpl:'\x3cspan id\x3d"{id}-btnWrap" data-ref\x3d"btnWrap" role\x3d"presentation" unselectable\x3d"on" style\x3d"{btnWrapStyle}" ' + 'class\x3d"{btnWrapCls} {btnWrapCls}-{ui} {splitCls}{childElCls}"\x3e' + '\x3cspan id\x3d"{id}-btnEl" data-ref\x3d"btnEl" role\x3d"presentation" unselectable\x3d"on" style\x3d"{btnElStyle}" ' + 'class\x3d"{btnCls} {btnCls}-{ui} {textCls} {noTextCls} {hasIconCls} ' + '{iconAlignCls} {textAlignCls} {btnElAutoHeightCls}{childElCls}"\x3e' + '\x3cspan id\x3d"{id}-badgeEl" data-ref\x3d"badgeEl" class\x3d"abp-badge"' + 
'style\x3d"\x3ctpl if\x3d"Ext.isEmpty(badgeValue)"\x3edisplay: none;\x3c/tpl\x3e\x3ctpl if\x3d"badgePriority !\x3d undefined"\x3ebackground-color: {badgePriority};\x3c/tpl\x3e"\x3e' + '{badgeValue}' + '\x3c/span\x3e' + '\x3ctpl if\x3d"iconBeforeText"\x3e{[values.$comp.renderIcon(values)]}\x3c/tpl\x3e' + '\x3cspan id\x3d"{id}-btnInnerEl" data-ref\x3d"btnInnerEl" unselectable\x3d"on" ' + 'class\x3d"{innerCls} {innerCls}-{ui}{childElCls}"\x3e{text}\x3c/span\x3e' + '\x3ctpl if\x3d"!iconBeforeText"\x3e{[values.$comp.renderIcon(values)]}\x3c/tpl\x3e' + 
'\x3c/span\x3e' + '\x3c/span\x3e' + '{[values.$comp.getAfterMarkup ? values.$comp.getAfterMarkup(values) : ""]}' + '\x3ctpl if\x3d"closable"\x3e' + '\x3cspan id\x3d"{id}-closeEl" data-ref\x3d"closeEl" class\x3d"{baseCls}-close-btn"\x3e' + '\x3ctpl if\x3d"closeText"\x3e' + ' {closeText}' + '\x3c/tpl\x3e' + '\x3c/span\x3e' + '\x3c/tpl\x3e' + '\x3ctpl if\x3d"split"\x3e' + '\x3cspan id\x3d"{id}-arrowEl" class\x3d"{arrowElCls}" data-ref\x3d"arrowEl" ' + 'role\x3d"button" hidefocus\x3d"on" unselectable\x3d"on"' + 
'\x3ctpl if\x3d"tabIndex !\x3d null"\x3e tabindex\x3d"{tabIndex}"\x3c/tpl\x3e' + '\x3ctpl foreach\x3d"arrowElAttributes"\x3e {$}\x3d"{.}"\x3c/tpl\x3e' + ' style\x3d"{arrowElStyle}"' + '\x3e{arrowElText}\x3c/span\x3e' + '\x3c/tpl\x3e', updateBadgeValue:function(value, oldValue) {
  var animate = false;
  value > oldValue;
  ...
  if (Ext.isEmpty(me.__delayedTaskUpdateBadge)) {
    me.__delayedTaskUpdateBadge = new Ext.util.DelayedTask(me.doUpdateBadge, me, [animate]);
  }
  me.__delayedTaskUpdateBadge.delay(100, null, null, [animate]);
  ...
  var me = this;
  var badgeData = me.getBadgeData(), badgeEl = me.badgeEl, badgeDom = badgeEl ? badgeEl.dom : null;
  ...
  if (badgeData.badgePriority != undefined) {
    if (badgeData.badgePriority !== ABP.util.Constants.badgePriority.Alert && badgeData.badgePriority !== ABP.util.Constants.badgePriority.Warning && badgeData.badgePriority !== ABP.util.Constants.badgePriority.Success && badgeData.badgePriority !== ABP.util.Constants.badgePriority.Info) {
    ...
    badgeEl.setStyle({'background-color':badgeData.badgePriority});
  }
}});
...
Ext.define('ABP.view.components.ProfileImage', {extend:'Ext.Container', alias:'widget.abpprofileimage', config:{displayName:null, src:null, icon:'icon-user'}, baseCls:'abp-profile-picture', layout:'fit', referenceHolder:true, defaults:{top:0, left:0, height:'100%'}, items:[{xtype:'component', reference:'initials', cls:'abp-profile-picture-icon', html:''}, {xtype:'image', reference:'image', cls:'abp-profile-picture-image', hidden:true, listeners:{element:'el', error:function() {
...
Ext.define('ABP.view.components.aria.HeaderComponent', {extend:'Ext.Component', alias:'widget.abpheadercomponent', ariaRole:'header', ariaAttributes:{'aria-level':'2'}});
Ext.define('ABP.view.components.panel.HeaderPanelBase', {extend:'Ext.Panel', alias:'widget.abpheaderpanel', closable:false, scrollable:true, header:{}, items:[], config:{isFavorite:null}, showBack:false, backHandler:Ext.emptyFn, showFavorite:false, showFilter:false, filterDelay:undefined, filterThreshold:1, filterEmptyText:'{i18n.abp_filter_empty_text:htmlEncode}', listeners:{beforedestroy:function() {
  if (this.filterTask) {
...
}, privates:{favIconOn:'icon-favorite-full', favIconOff:'icon-favorite-empty', filterTask:null, updateIsFavorite:function(newValue) {
  var me = this;
  if (!me.rendered) {
    return;
  }
  ...
  if (ABP.util.Common.getClassic() || Ext.os.deviceType !== 'Phone') {
    return {xtype:'textfield', itemId:'headerFilter', flex:3, maxWidth:300, minWidth:200, margin:'0px 5px 0px 0px', reference:'headerFilter', bind:{value:'{headerFilterValue}', emptyText:me.filterEmptyText}, keyMap:{ESC:function() {
      this.setValue('');
    }}, listeners:{change:me.onFilterChanged, scope:me}};
  }
  ...
  if (me.showFilter) {
    if (me.header && me.header.items) {
      ...
      var header = {userCls:'header-input-fields', items:[me.filterField()]};
      me.header = header;
    }
  }
  return;
  ...
  me.callParent();
  if (me.showBack) {
    me.getHeader().insert(0, {xtype:'tool', itemId:'backButton', iconCls:'icon-fa-arrow-left', callback:me.backHandler, bind:{tooltip:'{i18n.button_back:htmlEncode}'}});
  }
  if (me.showFavorite) {
    ...
    me.getHeader().add({xtype:'tool', itemId:'favoriteButton', reference:'favoriteButton', iconCls:me.isFavorite ? me.favIconOn : me.favIconOff, callback:me.onSwitchFavorite, scope:me, bind:{tooltip:me.isFavorite ? '{i18n.button_unfavorite:htmlEncode}' : '{i18n.button_favorite:htmlEncode}'}});
  }
}}});
Ext.define('ABP.view.control.ABPLoggingPopupController', {extend:'Ext.app.ViewController', alias:'controller.loggingpopup', config:{clearLogsClickCount:0}, constructor:function() {
  this.callParent();
}, onCloseClick:function() {
  var me = this;
  ...
  if (me.getClearLogsClickCount() > 0) {
    ...
    view.down('#clearLogsButtonContainer').add({xtype:'component', cls:'loggingpanel-button-text', html:'Clear Logs'});
...
Ext.define('ABP.view.control.ABPLoggingPopup', {extend:'Ext.panel.Panel', requires:['ABP.view.control.ABPLoggingPopupController', 'ABP.util.Logger'], alias:'widget.loggingpopup', controller:'loggingpopup', cls:'loggingpanel', bodyCls:'loggingpanel-body x-unselectable', floating:true, modal:true, maxHeight:Ext.getBody().getViewSize().height - 10, maxWidth:Ext.getBody().getViewSize().width - 10, title:'Log Viewer', config:{closeKeymap:undefined}, tools:[{type:'mytool', cls:'loggingpanel-close-tool', 
renderTpl:function() {
  return '\x3ci class\x3d"icon-delete"\x3e\x3c/i\x3e';
}, handler:'onCloseClick'}], dockedItems:[{xtype:'toolbar', cls:'loggingpanel-toolbar', dock:'bottom', defaults:{cls:'loggingpanel-button'}, items:['-\x3e', {xtype:'container', itemId:'clearLogsButtonContainer', layout:{type:'hbox', align:'stretch'}, items:[{xtype:'component', cls:'loggingpanel-button-icon', html:'\x3ci class\x3d"icon-garbage-can"\x3e\x3c/i\x3e'}], listeners:{el:{click:'onClickClearLogs'}}}, {xtype:'container', itemId:'saveWidgetButtonContainer', layout:{type:'hbox', align:'stretch'}, 
items:[{xtype:'component', cls:'loggingpanel-button-icon', html:'\x3ci class\x3d"icon-check"\x3e\x3c/i\x3e'}], listeners:{el:{click:'onClickSave'}}}]}], initComponent:function() {
  var me = this;
  var myWidth = Ext.getBody().getViewSize().width;
  myWidth = myWidth - 20;
  me.items = [{xtype:'abptextarea', value:ABP.util.Logger.getLogs(), spellcheck:false, inputAttrTpl:['autocomplete\x3d"off" wrap\x3d"off"'], height:Ext.getBody().getViewSize().height - 110, width:myWidth}];
  me.callParent();
  me.show();
...
Ext.define('ABP.view.session.accessibility.JumpToBar', {extend:'Ext.Container', requires:['ABP.view.session.accessibility.JumpToBarController', 'ABP.view.session.accessibility.JumpToBarViewModel'], dock:'top', alias:'widget.jumptobar', xtype:'jumptobar', controller:'jumptobar', viewModel:'jumptobar', layout:{type:'hbox', align:'stretch', pack:'center'}, cls:'jump-to-bar', padding:4, height:40, hideMode:'offsets', hidden:true, tabIndex:0, listeners:{focusenter:'onFocusEnter', focusleave:'onFocusLeave', 
show:'onShow'}, items:[{xtype:'combobox', itemId:'JumpToCombo', bind:{store:'{targets}', fieldLabel:'{i18n.toolbar_jumpTo:htmlEncode}', emptyText:'{i18n.toolbar_placeinapplication:htmlEncode}'}, queryMode:'local', displayField:'text', labelWidth:245, labelAlign:'right', forceSelection:true, flex:1, maxWidth:500, listeners:{select:'onSelection'}}, {xtype:'component', cls:'jump-to-help', componentCls:'x-unselectable', html:'press \x3cspan\x3eALT\x3c/span\x3e+\x3cspan\x3e/\x3c/span\x3e to show this menu', 
tabIndex:-1, flex:1}]});
Ext.define('ABP.view.session.help.HelpTile', {extend:'Ext.container.Container', alias:'widget.helptile', layout:{type:'vbox', align:'center'}, config:{title:'', links:[]}, minHeight:220, cls:'abphelptile-tilebody', items:[{xtype:'component', itemId:'abp-helptile-title', cls:'abphelptile-title', width:'90%'}, {xtype:'container', width:'100%', layout:{type:'vbox', align:'center'}, cls:'abphelptile-links', itemId:'abp-helptile-body'}], constructor:function(args) {
  var me = this;
  var items = me.items;
  ...
  for (var i = 0; i < args.links.length; ++i) {
    linksToAdd.push({xtype:'button', uiCls:'abp-link', cls:'link_link' + ' a-help-link-' + args.links[i].product.replace(' ', '-') + '-' + args.links[i].type.replace(' ', '-'), text:args.links[i].name, url:args.links[i].link, handler:'linkClick'});
  }
  items[1].items = linksToAdd;
  items[0].html = Ext.htmlEncode(args.title);
  me.callParent(args);
}});
Ext.define('ABP.view.session.help.HelpView', {extend:'ABP.view.components.panel.HeaderPanelBase', alias:'widget.helpview', requires:['ABP.view.session.help.HelpController', 'ABP.view.session.help.HelpViewModel', 'ABP.view.session.help.HelpTile'], controller:'helpcontroller', viewModel:{type:'helpviewviewmodel'}, bind:{title:'{i18n.help_title:htmlEncode}'}, layout:{type:'vbox', pack:'start'}, cls:'x-unselectable help-container', closable:true, items:[{xtype:'container', minHeight:200, width:'100%', 
cls:'help_aptean_header', layout:{type:'vbox', align:'middle', pack:'center'}, items:[{xtype:'component', width:250, height:40, itemId:'help-aptean-logo', cls:'help_aptean_logo'}, {xtype:'label', width:'50%', cls:'help_aptean_text', bind:{text:'{i18n.help_text:htmlEncode}'}, flex:1}]}, {xtype:'container', reference:'abp-help-tile-container', cls:'abp-help-tile-container', width:'100%', defaultType:'helptile'}], initComponent:function() {
  var me = this;
  me.callParent();
  me.getViewModel().LoadStoreData();
  me.fireEvent('helpview_intialLoad');
}});
Ext.define('ABP.view.session.about.AboutViewModel', {extend:'Ext.app.ViewModel', alias:'viewmodel.about', requires:[], data:{appTitle:''}});
Ext.define('ABP.view.session.about.AboutItem', {extend:'Ext.container.Container', alias:'widget.aboutitem', layout:{type:'vbox', pack:'center', align:'center'}, cls:'x-unselectable about-item-container', config:{showIcon:undefined, icon:undefined, name:undefined, version:undefined, build:undefined, detail:undefined, copyright:undefined}, minHeight:120, initComponent:function() {
  var me = this;
  var linkcls = '';
  me.items = [];
  if (me.getShowIcon()) {
    if (me.getIcon()) {
      me.items.push({xtype:'component', cls:'about-item-icon icon-' + me.getIcon()});
    } else {
      me.items.push({xtype:'component', cls:'about-item-icon icon-gearwheel'});
    }
  }
  me.items.push({xtype:'component', cls:'about-item-title', html:me.getName()});
  if (me.getVersion()) {
    me.items.push({xtype:'component', cls:'about-item-text', bind:{html:'{i18n.about_version:htmlEncode} ' + me.getVersion()}});
  }
  if (me.getBuild()) {
    me.items.push({xtype:'component', cls:'about-item-text', bind:{html:'{i18n.about_build:htmlEncode} ' + me.getBuild()}});
  }
  if (me.getCopyright()) {
    me.items.push({xtype:'component', cls:'about-item-text', html:me.getCopyright()});
  }
  if (me.getDetail()) {
    linkcls = 'a-about-' + me.getName().replace(' ', '-');
    me.items.push({xtype:'component', cls:'about-item-detail' + ' ' + linkcls, bind:{html:'{i18n.about_detail:htmlEncode}'}, listeners:{el:{click:function() {
      ABP.view.base.popUp.PopUp.customPopup(me.getDetail(), me.getName());
    }}}});
  }
  me.callParent();
}});
Ext.define('ABP.view.session.about.About', {extend:'ABP.view.components.panel.HeaderPanelBase', alias:'widget.about', requires:['ABP.view.session.about.AboutViewModel', 'ABP.view.session.about.AboutController', 'ABP.view.session.about.AboutItem', 'ABP.view.control.ABPLoggingPopup'], controller:'about', viewModel:{type:'about'}, bind:{title:'{i18n.about_title:htmlEncode}'}, layout:{type:'vbox'}, cls:'x-unselectable about-container', closable:true, minWidth:300, items:[{xtype:'container', layout:{type:'hbox'}, 
width:'100%', cls:'about-section-header-container', items:[{xtype:'component', flex:1, cls:'about-section-header-side'}, {xtype:'component', bind:{html:'{i18n.about_applications:htmlEncode}'}, cls:'about-section-header'}, {xtype:'component', flex:1, cls:'about-section-header-side'}]}, {xtype:'container', width:'100%', cls:'about-section about-section-top', layout:{type:'vbox', align:'center'}, items:[{xtype:'component', bind:{html:'{i18n.about_info:htmlEncode}'}, cls:'about-section-info', width:'100%'}, 
{xtype:'container', cls:'about-tile-container', width:'100%', itemId:'aboutAppsList', items:[]}]}, {xtype:'container', layout:{type:'hbox'}, width:'100%', cls:'about-section-header-container', items:[{xtype:'component', flex:1, cls:'about-section-header-side'}, {xtype:'component', bind:{html:'{i18n.about_thirdparty:htmlEncode}'}, cls:'about-section-header'}, {xtype:'component', flex:1, cls:'about-section-header-side'}]}, {xtype:'container', width:'100%', cls:'about-section about-section-bottom', 
itemId:'aboutThirdPartySection', layout:{type:'vbox', align:'center'}, items:[{xtype:'container', cls:'about-tile-container', width:'100%', itemId:'aboutThirdPartyList', items:[]}]}]});
Ext.define('ABP.view.session.logger.LoggerPage', {extend:'ABP.view.components.panel.HeaderPanelBase', alias:'widget.loggerpage', requires:['ABP.util.Logger', 'ABP.view.session.logger.LoggerController', 'ABP.view.session.logger.LoggerViewModel'], controller:'loggerpagecontroller', viewModel:{type:'loggerviewmodel'}, bind:{title:'{i18n.logger_title:htmlEncode}'}, layout:{type:'vbox', align:'stretch', pack:'center'}, closable:true, showFilter:true, listeners:{abp_header_filterChange:'onFilterChanged'}, 
header:{items:[{xtype:'combo', bind:{store:'{severity}'}, flex:2, minWidth:200, maxWidth:300, itemId:'loggerSeverity', hideLabel:true, displayField:'display', valueField:'value', editable:false, forceSelection:true, autoSelect:true, value:'ALL', listeners:{change:'severityChanged'}}]}, cls:'about-container', height:'100%', width:'100%', tools:[{itemId:'clearLog', iconCls:'icon-garbage-can', callback:'clearClicked', bind:{tooltip:'{i18n.logger_clear:htmlEncode}'}}], items:[{xtype:'dataview', store:'ABPLoggingStore', 
autoScroll:false, margin:'8 0 8 0', itemSelector:'.log-item', scrollable:'y', flex:1, bind:{emptyText:'\x3cdiv class\x3d"no-log-items"\x3e{i18n.logger_nothingtodisplay}\x3c/div\x3e'}, itemTpl:['\x3cdiv class\x3d"log-item {level:this.cls(values,parent[xindex-2],xindex-1,xcount)}"\x3e' + '{date:this.formatDate(values,parent[xindex-2],xindex-1,xcount)}' + '\x3cdiv class\x3d"time-wrap"\x3e' + '\x3cdiv class\x3d"log-item-abrev abp-logger-{level}" title\x3d"{level}"\x3e{level:this.firstChar}\x3c/div\x3e' + 
'{time:this.formatTime(values,parent[xindex-2],xindex-1,xcount)}' + '\x3c/div\x3e' + '\x3cdiv class\x3d"line-wrap"\x3e' + '\x3cdiv class\x3d"contents-wrap"\x3e' + '\x3clabel class\x3d"abp-logger-{level}"\x3e{level}\x3c/label\x3e' + '\x3cspan class\x3d"message"\x3e{message}\x3c/span' + '\x3cspan class\x3d"detail"\x3e{detail}\x3c/span\x3e' + '\x3c/div\x3e' + '\x3c/div\x3e' + '\x3c/div\x3e', {cls:function(value, record, previous, index, count) {
  var cls = '';
  if (!index) {
...
Ext.define('ABP.view.session.toolbarTop.ToolbarTopController', {extend:'ABP.view.session.toolbarTop.ToolbarTopBaseController', alias:'controller.toolbartopcontroller', init:function() {
  this.callParent();
  this.checkMenuButton();
  this.constructRightPane();
}, checkMenuButton:function() {
  var me = this, view = me.getView(), sessionConfig = ABP.util.Config.getSessionConfig();
  ...
  var me = this, view = me.getView(), sessionVm = view.up('sessioncanvas').getViewModel(), i, j, rightPaneTabs = [], sessionConfig = ABP.util.Config.getSessionConfig(), displayInitials = ABP.util.Config.getDisplayNameInitials(), profilePicture = ABP.util.Config.getProfilePicture(), notificationsEnabled = sessionConfig.settings.notifications.enabled, notificationPanelConfig = null, enabledRightPaneTabs = sessionConfig.settings.rightPane, registeredRightPaneTabs = ABP.util.Config.config.rightPaneTabs, 
  btnCls = '';
  ...
  if (Ext.isArray(rightPaneTabs) && rightPaneTabs.length > 0) {
    for (i = 0; i < rightPaneTabs.length; i++) {
      ...
      var button = {xtype:'abpbadgebutton', itemId:rightPaneItem.uniqueId, ariaRole:'menu', ariaAttributes:{'aria-expanded':false}, iconCls:rightPaneItem.icon + ' toolbar-icon', cls:btnCls + ' a-toolbar-rpsegment-' + rightPaneItem.uniqueId, uiCls:['dark'], scale:'large', hidden:rightPaneItem.invisible === true ? true : rightPaneItem.hidden, invisible:rightPaneItem.invisible, panelConfig:rightPaneItem, handler:'toggleRightPaneButton', keyMapEnabled:true, keyMap:{DOWN:'handleRightPaneKeyPress'}};
      if (rightPaneItem.tooltipKey) {
        button.bind = {tooltip:'{i18n.' + rightPaneItem.tooltipKey + ':htmlEncode}', ariaLabel:'{i18n.' + rightPaneItem.tooltipKey + ':ariaEncode}'};
      } else {
        if (rightPaneItem.tooltip) {
  ...
  if (notificationsEnabled) {
    notificationPanelConfig = {name:'abp-notifications', uniqueId:'abp-notifications', xtype:'abp-notifications', clearBadgeOnActivate:sessionConfig.settings.notifications.clearBadgeOnActivate};
    segmentedButtons.add({xtype:'abpbadgebutton', itemId:'abp-notifications', ariaRole:'menu', ariaAttributes:{'aria-expanded':false}, iconCls:'icon-bell toolbar-icon', cls:btnCls + ' a-toolbar-rpsegment-abp-notifications', uiCls:['dark'], scale:'large', panelConfig:notificationPanelConfig, handler:'toggleRightPaneButton', bind:{tooltip:'{i18n.abp_notifications_rightpane_title:htmlEncode}', ariaLabel:'{i18n.abp_notifications_rightpane_title:ariaEncode}'}, keyMapEnabled:true, keyMap:{DOWN:'handleRightPaneKeyPress'}});
    me.fireEvent('rightPane_initTab', 'abp-notifications', notificationPanelConfig);
  }
  var button = {xtype:'abpbadgebutton', ariaRole:'menu', ariaAttributes:{'aria-expanded':false}, itemId:'abp-settings', ariaRole:'menu', iconCls:'', cls:btnCls + ' a-toolbar-rpsegment-abp-settings', uiCls:['dark'], scale:'large', tabIndex:0, panelConfig:{name:'abp-settings', uniqueId:'abp-settings', xtype:'settingscontainer'}, handler:'toggleRightPaneButton', icon:profilePicture, bind:{icon:'{profilePhoto}', tooltip:'{i18n.sessionMenu_settings:htmlEncode}', ariaLabel:'{i18n.sessionMenu_settings:ariaEncode}'}, 
  keyMapEnabled:true, keyMap:{DOWN:'handleRightPaneKeyPress'}};
  if (profilePicture) {
  ...
  return button;
}, privates:{__updateBadge:function(btnUniqueId, badgeConfig) {
  var me = this;
...
Ext.define('ABP.view.session.toolbarTop.ToolbarItem', {extend:'Ext.button.Button', alias:'widget.toolbarbutton', config:{ico:'', uniqueId:'', command:'', args:'', enabled:true, tooltip:'', tooltipKey:'', type:'', appId:'', button:'default'}, cls:'toolbar-menu-btn ', overCls:'toolbar-menu-btn-over', handler:function(f, e) {
  if (e.type === 'click') {
    this.clickItem();
  } else {
    this.enterItem();
  ...
  font = font.split('-');
  var iconFont = font[0] === 'fa' ? font[0] + ' ' + me.ico : 'oCol' + ' ' + me.ico;
  me.setHtml('\x3ci class\x3d"' + iconFont + '"\x3e\x3c/i\x3e');
  me.focusable = true;
...
Ext.define('ABP.view.session.toolbarTop.search.SearchPopup', {extend:'Ext.container.Container', alias:'widget.searchpopup', floating:true, hidden:true, tabIndex:0, cls:'abp-popup-list', items:[{xtype:'dataview', itemId:'searchPopupDataview', tabIndex:0, overItemCls:'abp-popup-item-highlight', bind:{store:'{suggestions}', selection:'{selectedSuggestion}'}, tpl:['\x3ctpl for\x3d"."\x3e', '\x3cdiv class\x3d"abp-popup-list-outer"\x3e', '\x3cdiv class\x3d"abp-popup-list-searched"\x3e{text:htmlEncode}\x3c/div\x3e', 
'\x3cdiv class\x3d"abp-popup-list-hierarchy"\x3e{hierarchy:htmlEncode}\x3c/div\x3e', '\x3c/div\x3e', '\x3c/tpl\x3e'], itemSelector:'div.abp-popup-list-outer', listeners:{itemclick:'onSuggestionClick'}}, {xtype:'component', itemId:'loading', html:'\x3cdiv class\x3d"abp-loadmask loading-bars"\x3e\x3cdiv class\x3d"bars slim"\x3e \x3cdiv class\x3d"rect1"\x3e\x3c/div\x3e \x3cdiv class\x3d"rect2"\x3e\x3c/div\x3e \x3cdiv class\x3d"rect3"\x3e\x3c/div\x3e \x3cdiv class\x3d"rect4"\x3e\x3c/div\x3e \x3cdiv class\x3d"rect5"\x3e\x3c/div\x3e \x3c/div\x3e\x3c/div\x3e'}, 
{xtype:'label', cls:'searchpopupmessage', itemId:'message', hidden:true, html:null}], setLoading:function(loading) {
  if (loading) {
...
Ext.define('ABP.view.session.toolbarTop.search.SearchBar', {extend:'Ext.container.Container', alias:'widget.searchbar', requires:['ABP.view.session.toolbarTop.search.SearchBarController', 'ABP.view.session.toolbarTop.search.SearchBarViewModel', 'ABP.view.session.toolbarTop.search.SearchPopup'], controller:'searchbarcontroller', viewModel:{type:'searchbarmodel'}, width:45, bind:{height:'{toolbarHeight}'}, listeners:{focusleave:'onFocusLeave'}, cls:'searchbar', layout:{type:'hbox', align:'center', 
pack:'end'}, items:[{xtype:'abpbutton', itemId:'searchbarTypeButton', scale:'large', uiCls:['dark'], hidden:true, bind:{menu:'{searchBar.menuOptions}', iconCls:'{searchBar.selectedSearchCls}', hidden:'{!showBarMenuButton}', ariaLabel:'{i18n.button_search}'}, height:44}, {xtype:'textfield', itemId:'searchbarSearchField', reference:'searchbarSearchField', cls:'searchbar-searchfield a-searchbar-searchfield', inputAttrTpl:'spellcheck\x3d"false"', ariaRole:'combobox', hidden:true, hideLabel:true, bind:{emptyText:'{emptyText}', 
ariaLabel:'{emptyText}', hideLabel:true, hidden:'{!searchBar.open}', value:'{searchBar.val}'}, height:32, width:225, enableKeyEvents:true, listeners:{change:'onSearchFieldChange', focus:'onSearchFieldFocus', show:function() {
  this.focus();
}, el:{keydown:'onSearchFieldKeyDown'}, hide:'ensureSuggestionsHidden'}, keyMap:{ESC:'onEscKey', ENTER:'onEnterKey', 'CTRL+DOWN':'onSwitchProviderDown', 'CTRL+UP':'onSwitchProviderUp', 'ALT+191':{alt:true, fn:'onJumpToKey', defaultEventAction:'stopPropagation'}}, ariaAttributes:{'aria-owns':'GlobalSuggestionPopup', 'aria-controls':'GlobalSuggestionPopup', 'aria-haspopup':'listbox', 'aria-expanded':'false', 'aria-autocomplete':'list', 'aria-activedescendant':''}}, {xtype:'searchpopup', id:'GlobalSuggestionPopup'}, 
{xtype:'abpbutton', itemId:'searchbarAdvancedButton', focusCls:'', overCls:'searchbar-button-over', cls:'searchbar-button a-searchbar-advancedbutton', height:44, bind:{text:'{i18n.search_advanced:htmlEncode}', ariaLabel:'{i18n.search_advanced}'}, hidden:true}], initComponent:function() {
  var me = this;
  var items = me.items;
  ...
  if (toggleable === false) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      if (item.itemId === 'searchbarSearchField') {
        ...
        item.triggers = {search:{cls:'icon-magnifying-glass', automationCls:'global-search-trigger', handler:'onSearchClick'}};
      }
    }
    me.callParent();
    ...
    items.push({xtype:'abpbutton', itemId:'searchbarSearchButton', uiCls:['dark'], iconCls:'icon-magnifying-glass', scale:'large', bind:{tooltip:'{i18n.sessionMenu_search:htmlEncode}', ariaLabel:'{i18n.search_toggle}', ariaExpanded:'{searchBar.open}'}, height:44, width:45, handler:'onSearchClick'});
    me.callParent();
  }
}});
Ext.define('ABP.view.session.toolbarTop.ToolbarTop', {extend:'Ext.container.Container', alias:'widget.toolbartop', requires:['ABP.view.session.toolbarTop.ToolbarTopController', 'ABP.view.session.toolbarTop.ToolbarTopModel', 'ABP.view.session.toolbarTop.ToolbarItem', 'ABP.view.session.toolbarTop.search.SearchBar', 'ABP.view.buttons.BadgeButton'], controller:'toolbartopcontroller', viewModel:{type:'toolbartopmodel'}, ariaRole:'menubar', currentFocus:-1, focusable:true, dock:'top', bind:{height:'{toolbarHeight}'}, 
ariaLabel:'Toolbar', ui:'abp-toolbar', layout:'hbox', autoEl:'header', items:[{xtype:'container', align:'left', layout:{type:'hbox'}, itemId:'tool-buttons-left', docked:'left', cls:'left-cont', items:[{xtype:'abpbutton', automationCls:'toolbar-main-menu', uiCls:['dark'], cls:'tool-button-left abp-icon-button', ariaLabel:'{i18n.toolbar_toggleNavigation:ariaEncode}', scale:'large', ariaAttributes:{'aria-owns':'main-navigation-menu'}, bind:{height:'{toolbarHeight}', ariaLabel:'{i18n.toolbar_toggleNavigation:ariaEncode}', 
ariaExpanded:'{menuOpen}', tooltip:'{i18n.toolbar_toggleNavigation:htmlEncode}'}, iconCls:'icon-menu', itemId:'toolbar-button-menu', handler:'toggleMenu'}, {xtype:'component', itemId:'toolbar-top-title', width:205, bind:{html:'{mainMenuTopLabel}', cls:'{toolbarBrandingCls}', height:'{toolbarHeight}', hidden:'{!toolbarTitleBrandNameShow || toolbarTitleBrandImageShow}'}, cls:'toolbar-top-title', setCls:function(nClass) {
  this.addCls(nClass);
}}, {xtype:'container', cls:'toolbar-title-image-container', overCls:'mouse-over', layout:'fit', width:205, bind:{height:'{toolbarHeight}', hidden:'{!toolbarTitleBrandImageShow}'}, listeners:{beforerender:'toolbarTitleImageContainerBeforeRender', el:{click:'toolbarTitleImageClick'}}}]}, {xtype:'container', itemId:'toolbarTitleContainer', flex:1, ariaRole:'banner', ariaAttributes:{'aria-labelledby':'toolbarTitle'}, items:[{xtype:'component', autoEl:'h1', itemId:'toolbarTitle', id:'toolbarTitle', cls:'toolbar-title', 
bind:{html:'{toolbarTitle}', height:'{toolbarHeight}'}}]}, {xtype:'container', align:'right', layout:{type:'hbox', align:'end', pack:'end'}, itemId:'tool-buttons-right', docked:'right', cls:'right-cont', items:[], bind:{height:'{toolbarHeight}'}, addButton:function(buttonToAdd) {
  var me = this;
  me.insert(0, buttonToAdd);
}}, {xtype:'segmentedbutton', itemId:'rightpaneButtons', bind:{height:'{toolbarHeight}'}, defaults:{userCls:'button-dark-contrast'}, allowMultiple:false, allowDepress:true, items:[]}], listeners:{resize:'onResizeToolbar', afterlayout:'onAfterLayout'}});
Ext.define('ABP.view.session.mainMenu.MenuItem', {extend:'Ext.container.Container', alias:'widget.menubutton', requires:['ABP.view.session.mainMenu.MenuItemModel'], viewModel:{type:'menuitemmodel'}, config:{icon:'', uniqueId:'', title:'', labelKey:'', labelVal:'', tabId:'', command:'', args:'', enabled:true, tooltip:'', tooltipKey:'', shorthand:'', type:'', children:'', place:'', appId:''}, cls:'menu-item mi-Body', ui:'menuitem', uiCls:'dark', overCls:'x-hover', layout:{type:'hbox', align:'center'}, 
height:41, bind:{width:'{menuWidth}'}, afterRender:function() {
  var me = this;
  var ttString = '';
  var keyString;
  me.callParent();
  ...
  if (ttString !== '') {
    me.tooltip = Ext.create('Ext.tip.ToolTip', {target:me.getId(), text:ttString, cls:'tooltip-mm', listeners:{beforeshow:function(scope, eOpts) {
  ...
  if (me.icon && me.icon[0] !== '{' && (me.title && me.title[0] !== '{')) {
    iconFont = font[0] === 'fa' ? 'fa ' + me.icon : me.icon;
    if (!me.labelKey) {
    ...
    items.push({xtype:'component', itemId:'miIcon', html:'\x3ci class\x3d"' + iconFont + '"\x3e\x3c/i\x3e', cls:'mi-icon-micro', bind:{cls:'{classicMenuExpand}'}, setCls:function(expand) {
      if (expand) {
    ...
    items.push({xtype:'component', itemId:'miIcon', cls:'mi-icon-micro', bind:{cls:'{classicMenuExpand}', html:'\x3ci class\x3d"' + me.icon + '"\x3e\x3c/i\x3e'}, setCls:function(expand) {
      if (expand) {
        this.removeCls('icon-expanded');
      } else {
        this.addCls('icon-expanded');
  ...
  items.push({xtype:'component', itemId:'miTitle', bind:{hidden:'{!classicMenuExpand}', html:me.labelKey ? '{i18n.' + me.labelKey + '}' : me.title}, cls:'mi-title-micro'});
  if (me.shorthand) {
    items.push({xtype:'component', itemId:'miShorthand', html:me.shorthand, cls:'mi-shorthand', ariaAttributes:{'aria-hidden':'true'}});
  }
  me.items = items;
  me.ariaRole = 'menuitem';
  me.ariaLabel = 'Main Menu ' + me.title;
  me.callParent(arguments);
}, listeners:{el:{keydown:function(f, e) {
...
Ext.define('ABP.view.session.mainMenu.MenuItemUserModel', {extend:'Ext.app.ViewModel', alias:'viewmodel.menuitemusermodel', data:{userDisplay:''}});
Ext.define('ABP.view.session.mainMenu.MenuItemUserController', {extend:'Ext.app.ViewController', alias:'controller.menuitemusercontroller', init:function() {
  this.startTime = Date.now();
}, onRenderUser:function(p) {
  var me = this;
  var vm = me.getViewModel();
  var theTip = Ext.create('Ext.tip.Tip', {html:'', cls:'user-tip', margin:'0 0 0 0', color:'#fff', shadow:false});
  ...
  var showFn = function() {
    var statusString = vm.get('i18n.sessionMenu_user') + ' ' + vm.get('userDisplay') + '\x26nbsp;\x26nbsp;\x26nbsp;\x26nbsp;' + vm.get('i18n.sessionMenu_environment') + ' ' + currentEnv + '\x26nbsp;\x26nbsp;\x26nbsp;\x26nbsp;' + vm.get('i18n.sessionMenu_time') + me.getUseTime();
...
Ext.define('ABP.view.session.mainMenu.MenuItemUser', {extend:'Ext.container.Container', alias:'widget.menuitemuser', requires:['ABP.view.session.mainMenu.MenuItemUserModel', 'ABP.view.session.mainMenu.MenuItemUserController'], controller:'menuitemusercontroller', viewModel:{type:'menuitemusermodel'}, config:{icon:'', title:'', header:'', value:'\x26nbsp;', tabId:'', command:'', clickOnRender:false}, cls:'Menu_User', layout:{type:'hbox', align:'center', pack:'center'}, height:25, width:'auto', initComponent:function() {
  var me = this;
  var vm = me.getViewModel();
  var width = 'auto';
  var user = ABP.util.Config.getUsername();
  ...
  me.items = [{xtype:'component', html:'\x3ci class\x3d"' + me.icon + '"\x3e\x3c/i\x3e', cls:'mi-icon-user'}, {xtype:'component', html:user, width:width, cls:'mi-title-user'}];
  me.callParent(arguments);
}, listeners:{render:'onRenderUser'}});
Ext.define('ABP.view.session.mainMenu.MenuScroll', {extend:'Ext.container.Container', alias:'widget.menuscroll', afterRender:function() {
  this.callParent();
  var me = this;
  ...
  if (!this.iScroll) {
    ...
    if (el.children.length > 0) {
      this.iScroll = new IScroll(el, {mouseWheel:true, click:false, preventDefault:false, scrollbars:true, fadeScrollbars:false});
...
Ext.define('ABP.view.session.mainMenu.MenuToggle', {extend:'ABP.view.session.mainMenu.MenuItem', alias:'widget.menutoggle', initComponent:function() {
  var me = this;
  var iconFont = '';
  var font = me.icon;
  font = font.split('-');
  me.items = [{xtype:'component', itemId:'miIcon', cls:'mi-icon-micro', bind:{cls:'{classicMenuExpand}', html:'\x3ci class\x3d"' + me.icon + '"\x3e\x3c/i\x3e'}, setCls:function(expand) {
    if (expand) {
      this.removeCls('icon-expanded');
    } else {
      this.addCls('icon-expanded');
    }
  }}, {xtype:'component', itemId:'miTitle', bind:{hidden:'{!classicMenuExpand}', html:me.labelKey ? '{i18n.' + me.labelKey + ':htmlEncode}' : Ext.String.htmlEncode(me.title)}, cls:'mi-title-micro'}, {xtype:'component', itemId:'miToggle', cls:'mi-icon-micro mi-icon-toggle', bind:{html:'\x3cdiv class\x3d"icon-wrapper"\x3e\x3ci class\x3d"' + 'icon-elements-tree' + '"\x3e\x3c/i\x3e\x3ci class\x3d"' + '{navIcon}' + '"\x3e\x3c/i\x3e\x3c/div\x3e'}}];
  me.ariaRole = 'menuitem';
  me.ariaLabel = 'Main Menu ' + me.title;
...
autoEl:'nav', cls:'main-menu', id:'main-navigation-menu', ui:'nav-menu', itemId:'mainMenu', reference:'mainMenu', focusItemsCt:0, currentFocus:0, startIdx:-1, dirtyIdx:true, lastInitMouseBool:true, componentCls:'main-menu x-unselectable', layout:{type:'vbox', align:'begin', pack:'start'}, bind:{width:'{menuWidth}', ariaLabel:'{i18n.abp_navigation_menu}'}, items:[{xtype:'container', cls:'nav-search-cont', reference:'abpNavSearchCont', margin:'3px 0', height:34, layout:{type:'vbox', align:'middle', 
pack:'start'}, bind:{width:'{menuWidth}', hidden:'{hideSearch}'}, items:[{xtype:'abptext', cls:'nav-search-field', ariaRole:'combobox', inputAttrTpl:'spellcheck\x3d"false"', bind:{emptyText:'{i18n.navMenu_navigation}', fieldLabel:'{i18n.toolbar_search_navigation}', ariaLabel:'{i18n.toolbar_search_navigation}', hideLabel:true}, width:'90%', itemId:'navSearchField', automationCls:'navMenu-search-field', spellcheck:false, triggers:{search:{cls:'nav-search-trigger', iconCls:'magnifying-glass', automationCls:'navMenu-search-trigger', 
handler:'searchNav'}}, listeners:{change:'searchNav', focusleave:'onSearchLostFocus', el:{keydown:'onSearchKeyDown'}}, ariaAttributes:{'aria-owns':'searchResultsView', 'aria-controls':'searchResultsView', 'aria-haspopup':'listbox', 'aria-expanded':'false', 'aria-autocomplete':'list', 'aria-activedescendant':''}}]}, {xtype:'container', cls:'nav-toggle-cont', layout:{type:'vbox', align:'stretch'}, bind:{width:'{menuWidth}'}, items:[{xtype:'menutoggle', uniqueId:'navToggleTree', itemId:'navToggleTree', 
icon:'icon-refresh', title:'Schwap View', automationCls:'navMenu-swapView', labelKey:'navMenu_swapView', tooltipKey:'navMenu_swapView', command:'toggleNav', enabled:true, type:'event', appId:'container', bind:{hidden:'{hideTreeNav}', cls:'{navToggleIcon}'}}]}, {xtype:'container', cls:'main-menu-main-content', flex:1, scrollable:'y', bind:{width:'{menuWidth}'}, items:[{xtype:'container', items:[{xtype:'treelistmenu', bind:{store:'{navSearch}', width:'{menuWidth}'}}]}, {xtype:'container', cls:'menu-fade-bottom', 
itemId:'main_menu_session', flex:1, layout:{type:'vbox', align:'begin'}, bind:{items:'{sessionMenu}', width:'{menuWidth}'}, setItems:function(newItems) {
  Ext.suspendLayouts();
  this.removeAll();
  this.add(newItems);
  Ext.resumeLayouts(true);
...
Ext.define('ABP.view.session.subMenu.SubMenuModel', {extend:'Ext.app.ViewModel', alias:'viewmodel.submenumodel', data:{allItems:[], shownItems:[], numShown:0, numCounted:0, numSubVis:0, numTriVis:0, longestTitle:0, longestLabel:0}, shownSet:function(path, value) {
  var me = this;
  me.set(path, value);
  ...
  for (i = 0; i < me.data.shownItems.length; ++i) {
    if (me.data.shownItems[i].xtype === 'submenubutton') {
      ...
      if (me.data.shownItems[i].xtype === 'trimenubutton' && me.data.shownItems[i].hidden === false) {
        me.data.shownItems[i].place = navCt;
        navCt++;
      } else {
...
Ext.define('ABP.view.session.subMenu.SubMenuItemModel', {extend:'Ext.app.ViewModel', alias:'viewmodel.submenuitemmodel'});
Ext.define('ABP.view.session.subMenu.SubMenuItem', {extend:'Ext.container.Container', alias:'widget.submenubutton', requires:['ABP.view.session.subMenu.SubMenuItemModel'], viewModel:{type:'submenuitemmodel'}, config:{title:'', labelKey:'', labelVal:'', uniqueId:'', command:'', args:'', enabled:true, tooltip:'', tooltipKey:'', type:'', children:'', appId:'', place:'', parentUID:'', parentTitle:'', clas:''}, cls:'sub-menu-item smi-Body', itmeId:'smiBody', height:40, layout:{type:'hbox', align:'stretch'}, 
tabIndex:-1, afterRender:function() {
  var me = this;
  var vm;
  var ttString = '';
  var keyString;
  ...
  if (ttString !== '') {
    Ext.tip.QuickTipManager.register({target:me.getId(), text:ttString, cls:'tooltip-mm'});
  }
}, initComponent:function() {
  var me = this;
  var itemlist = [];
...
Ext.define('ABP.view.session.subMenu.TriMenuItemModel', {extend:'Ext.app.ViewModel', alias:'viewmodel.trimenuitemmodel'});
Ext.define('ABP.view.session.subMenu.TriMenuItem', {extend:'Ext.container.Container', alias:'widget.trimenubutton', requires:['ABP.view.session.subMenu.TriMenuItemModel'], viewModel:{type:'trimenuitemmodel'}, config:{title:'', labelKey:'', labelVal:'', uniqueId:'', command:'', args:'', enabled:true, tooltip:'', tooltipKey:'', type:'', children:'', appId:'', place:'', parentUID:'', parentTitle:'', clas:''}, cls:'tri-menu-item tri-Body', layout:{type:'vbox', align:'stretch'}, height:40, tabIndex:-1, 
afterRender:function() {
  var me = this;
  var vm;
  var ttString = '';
  ...
  this.items = [{xtype:'component', itemId:'triTitle', html:this.labelVal, cls:'tri-title', listeners:{el:{click:function() {
    this.clickItem();
  }, scope:this}}}];
  this.ariaRole = 'menuitem';
  this.ariaLabel = this.parentTitle + ' - ' + this.title;
...
Ext.define('ABP.view.session.subMenu.SubScroll', {extend:'Ext.container.Container', alias:'widget.subscroll', afterRender:function() {
  this.callParent();
  var me = this;
...
Ext.define('ABP.view.session.subMenu.SubMenu', {extend:'Ext.container.Container', alias:'widget.submenu', requires:['ABP.view.session.subMenu.SubMenuController', 'ABP.view.session.subMenu.SubMenuModel', 'ABP.view.session.subMenu.SubMenuItem', 'ABP.view.session.subMenu.TriMenuItem', 'ABP.view.session.subMenu.SubScroll'], controller:'submenucontroller', viewModel:{type:'submenumodel'}, focusItemsCt:0, currentFocus:-1, startIdx:-1, dirtyIdx:true, lastInitMouseBool:true, componentCls:'sub-menu x-unselectable', 
layout:'vbox', width:300, height:'100%', items:[{xtype:'container', layout:{type:'vbox', align:'stretch'}, cls:ABP.util.Config.isDesktop() ? 'noshowScroll' : '', width:300, itemId:'sub_menu_cont', enabledItemCount:0, autoScroll:!ABP.util.Config.isDesktop(), bind:{items:'{shownItems}'}, setItems:function(newItems) {
  Ext.suspendLayouts();
  this.removeAll(true);
  this.add(newItems);
  Ext.resumeLayouts(true);
...
Ext.define('ABP.view.session.favorites.FavoritesManagerController', {extend:'ABP.view.session.favorites.FavoritesManagerControllerBase', alias:'controller.favoritesManager', onExpandAllClick:function() {
  var me = this, view = me.getView();
  if (view.favTree) {
  ...
  view.favTree.getRootNode().insertChild(0, {text:value, iconCls:'icon-folder', label:value, leaf:false, expanded:false});
  ...
  var editPanel = Ext.create('ABP.view.session.favorites.FavoritesManagerEditPanel', {favorite:favorite, treeView:treeView, viewModel:{data:{allowItemRename:allowItemRename}}});
  editPanel.show();
...
Ext.define('ABP.view.session.favorites.FavoritesManager', {extend:'ABP.view.components.panel.HeaderPanelBase', alias:'widget.favoritesManager', requires:['Ext.tree.Panel', 'Ext.tree.Column', 'Ext.data.TreeStore', 'Ext.grid.plugin.CellEditing', 'Ext.tree.plugin.TreeViewDragDrop', 'ABP.view.session.favorites.FavoritesManagerController', 'ABP.view.session.favorites.FavoritesManagerModel'], viewModel:{type:'favoritesmanagermodel'}, controller:'favoritesManager', scrollable:'vertical', layout:{type:'vbox', 
align:'stretch'}, bind:{title:'{i18n.favorites_title:htmlEncode}'}, header:{automationCls:'favorites-manager-header'}, closable:true, items:[{xtype:'treepanel', rootVisible:false, itemId:'favoritestree', useArrows:true, ui:'abpgridpanel', plugins:{cellediting:{clicksToEdit:2, listeners:{beforeedit:function(editor, context, options) {
  var allowEdit = true;
  ...
  return allowEdit;
}}}}, viewConfig:{listeners:{nodedragover:function(targetNode, position, data, e, options) {
  ...
  return true;
}}, plugins:{treeviewdragdrop:{containerScroll:true}}}, listeners:{edit:function(plugin, context) {
  if (context.view) {
    context.view.refresh();
  }
}}, columns:[{xtype:'treecolumn', text:null, flex:0.5, dataIndex:'text', editor:{xtype:'textfield', allowBlank:false}}, {xtype:'actioncolumn', flex:0.5, listeners:{afterrender:function() {
  if (ABP.util.Common.getViewModelProperty('conf.settings.favorites.depthLimit') === 1 && ABP.util.Common.getViewModelProperty('conf.settings.favorites.allowItemRename') === false) {
    this.items[0].hidden = true;
  }
}}, items:[{width:30, iconCls:'icon-pencil', handler:'editItemClicked'}, {xtype:'actioncolumn', width:30, iconCls:'icon-navigate-cross', handler:'removeItemClicked'}]}]}], tbar:{reference:'tbar', cls:'favorites-tbar', defaults:{border:false}, bind:{height:'{toolbarHeight}'}, items:[{bind:{text:'{i18n.button_save:htmlEncode}'}, cls:'a-favorites-toolbar-save', width:100, handler:'onSaveClick'}, {bind:{text:'{i18n.favorites_expandAll:htmlEncode}', hidden:'{conf.settings.favorites.depthLimit \x3d\x3d\x3d 1}'}, 
cls:'a-favorites-toolbar-expandall', width:100, handler:'onExpandAllClick'}, {bind:{text:'{i18n.favorites_collapseAll:htmlEncode}', hidden:'{conf.settings.favorites.depthLimit \x3d\x3d\x3d 1}'}, cls:'a-favorites-toolbar-collapseall', width:100, handler:'onCollapseAllClick'}, {xtype:'textfield', height:32, bind:{emptyText:'{i18n.favorites_newGroup_emptyText}', value:'{favoriteTitle}', hidden:'{conf.settings.favorites.depthLimit \x3d\x3d\x3d 1}'}, cls:'a-favorites-toolbar-newgrouptext', itemId:'newgrouptext', 
keyMap:{'ENTER':{handler:'addNewGroup'}}, listeners:{change:'onChange'}, width:200}, {bind:{disabled:'{favoriteTitle.length \x3d\x3d\x3d 0}', hidden:'{conf.settings.favorites.depthLimit \x3d\x3d\x3d 1}'}, cls:'favorites-addgroup a-favorites-toolbar-newgroup', handler:'addNewGroup', border:true, iconCls:'icon-plus'}]}});
Ext.define('ABP.view.session.headlines.HeadlinesManager', {extend:'ABP.view.components.panel.HeaderPanelBase', alias:'widget.headlinesManager', requires:['ABP.view.components.panel.HeaderPanelBase', 'ABPControlSet.view.field.DateTime', 'ABP.view.session.headlines.HeadlinesManagerController', 'Ext.grid.plugin.RowWidget'], controller:'headlinesManager', cls:'headlines-manager-panel', scrollable:'vertical', layout:{type:'vbox', align:'stretch'}, bind:{title:'{i18n.headlines_title:htmlEncode}'}, closable:true, 
closeEvent:'headlinesManager_onCancelClick', destroyOnClose:false, header:{automationCls:'headlines-manager-header'}, items:[{xtype:'grid', flex:1, rootVisible:false, reference:'headlinesGrid', ui:'abpgridpanel', forceFit:true, plugins:{rowwidget:{widget:{xtype:'abpform', layout:{type:'column'}, bind:{data:'{record}'}, defaults:{margin:4, labelAlign:'top', colspan:1}, padding:4, items:[{xtype:'abptext', bind:{fieldLabel:'{i18n.headlines_label_message:htmlEncode}', value:'{record.message}'}, name:'message'}, 
{xtype:'abptext', bind:{fieldLabel:'{i18n.headlines_label_message_key:htmlEncode}', value:'{record.messageKey}'}, name:'messageKey'}, {xtype:'abptext', bind:{fieldLabel:'{i18n.headlines_label_action:htmlEncode}', value:'{record.actionText}'}, name:'actionText'}, {xtype:'abptext', bind:{fieldLabel:'{i18n.headlines_label_action_key:htmlEncode}', value:'{record.actionTextKey}'}, name:'actionTextKey'}, {xtype:'abpdatetime', bind:{fieldLabel:'{i18n.headlines_label_starttime:htmlEncode}', value:'{record.startTime}'}, 
name:'startTime'}, {xtype:'abpdatetime', bind:{fieldLabel:'{i18n.headlines_label_endtime:htmlEncode}', value:'{record.endTime}'}, name:'endTime'}, {xtype:'abpcheckbox', bind:{fieldLabel:'{i18n.headlines_label_published:htmlEncode}', value:'{record.published}'}, name:'published'}, {xtype:'abpradiogroup', bind:{fieldLabel:'{i18n.headlines_label_priority:htmlEncode}', value:'{record.priority}'}, name:'priority', items:[{bind:{boxLabel:'{i18n.headlines_priority_info:htmlEncode}'}, name:'priority', inputValue:0}, 
{bind:{boxLabel:'{i18n.headlines_priority_warning:htmlEncode}'}, name:'priority', inputValue:1}, {bind:{boxLabel:'{i18n.headlines_priority_alert:htmlEncode}'}, name:'priority', inputValue:2}]}], bbar:[{xtype:'abpbutton', handler:function(button) {
  var form = button.up('abpform'), headlinesManager = form.up('headlinesManager'), headlinesManagerController = headlinesManager.getController(), rowContext = form._rowContext, record = rowContext.record;
  headlinesManagerController.fireEvent('headline_save', record);
  record.save();
}, bind:{text:'{i18n.button_save:htmlEncode}', disabled:'{!record.dirty}'}}]}}}, columns:[{dataIndex:'message', bind:{text:'{i18n.headlines_column_message:htmlEncode}'}, text:'Message', flex:3}, {dataIndex:'messageKey', bind:{text:'{i18n.headlines_column_message_key:htmlEncode}'}, text:'Message key', hidden:true, flex:1}, {dataIndex:'actionText', bind:{text:'{i18n.headlines_column_action:htmlEncode}'}, flex:2}, {dataIndex:'actionTextKey', bind:{text:'{i18n.headlines_column_action_key:htmlEncode}'}, 
text:'Action key', hidden:true, flex:1}, {dataIndex:'startTime', bind:{text:'{i18n.headlines_column_starttime:htmlEncode}'}, flex:2}, {dataIndex:'endTime', bind:{text:'{i18n.headlines_column_endtime:htmlEncode}'}, flex:2}, {dataIndex:'published', bind:{text:'{i18n.headlines_column_published:htmlEncode}'}, flex:1}, {dataIndex:'priority', bind:{text:'{i18n.headlines_column_priority:htmlEncode}'}, flex:1, renderer:function(priority) {
  switch(priority) {
    case 0:
...
}}, {xtype:'actioncolumn', hideable:false, width:30, items:[{width:30, iconCls:'icon-navigate-cross', handler:'removeItemClicked'}]}]}], tbar:{reference:'tbar', cls:'headlines-tbar', defaults:{border:false}, bind:{height:'{toolbarHeight}'}, items:[{bind:{text:'{i18n.button_cancel:htmlEncode}'}, cls:'a-headlines-toolbar-cancel', width:100, handler:'onCancelClick'}, {bind:{text:'{i18n.headlines_new:htmlEncode}'}, cls:'a-headlines-toolbar-new', width:100, handler:'newHeadline'}]}});
Ext.define('ABP.view.session.feature.FeatureCanvas', {extend:'Ext.panel.Panel', alias:'widget.featurecanvas', requires:['ABP.view.session.help.HelpView', 'ABP.view.session.about.About', 'ABP.view.session.logger.LoggerPage', 'ABP.view.session.toolbarTop.ToolbarTop', 'ABP.view.session.feature.FeatureCanvasController', 'ABP.view.session.feature.FeatureCanvasModel', 'ABP.view.session.mainMenu.MainMenu', 'ABP.view.session.subMenu.SubMenu', 'ABP.view.session.favorites.FavoritesManager', 'ABP.view.session.headlines.HeadlinesManager'], 
controller:'featurecanvascontroller', viewModel:{type:'featurecanvasmodel'}, subMenuOpened:false, menuOpened:false, settingsShown:false, layout:'absolute', cls:'feature-canvas', ariaRole:'main', autoEl:'main', flex:1, initComponent:function() {
  var me = this;
  var vm = me.getViewModel();
  var autoHide = me.getViewModel().get('conf').settings.autoHideMenu;
  vm.set('autoHide', autoHide);
  me.items = [{xtype:'container', anchor:'100% 100%', layout:'fit', itemId:'topContainer', items:[{xtype:'container', anchor:'100% 100%', layout:'fit', itemId:'settingsContainer', items:[], hidden:true}, {xtype:'container', anchor:'100% 100%', style:'z-index: 2;', layout:'fit', itemId:'applicationContainer', items:[]}]}];
  me.callParent();
}});
Ext.define('ABP.view.session.rightPane.RightPaneController', {extend:'ABP.view.session.rightPane.RightPaneBaseController', alias:'controller.rightpanecontroller', __initTab:function(uniqueId, tabConfig) {
  ...
  var me = this, view = me.getView(), viewModel = view.getViewModel(), tabItemId, tab, activeTab, panelConfig = button.panelConfig, tabPrefix = viewModel.get('tabPrefix'), rightPaneOpen = viewModel.get('rightPaneOpen');
  ...
  var me = this, view = me.getView(), viewModel = view.getViewModel(), tabItemId, tab, activeTab, tabPrefix = viewModel.get('tabPrefix'), rightPaneOpen = viewModel.get('rightPaneOpen');
  ...
  if (rightPaneOpen === false && open !== false) {
    ...
    if (rightPaneOpen === true && activeTab.itemId === tabItemId && open !== true) {
      me.togglePane();
      return;
    } else {
      if (rightPaneOpen === true && activeTab.itemId !== tabItemId && open === false) {
        return;
      }
    }
  }
...
Ext.define('ABP.view.session.rightPane.RightPane', {extend:'Ext.tab.Panel', alias:'widget.rightpanecanvas', itemId:'rightPane', requires:['ABP.view.session.rightPane.RightPaneController', 'ABP.view.session.rightPane.RightPaneModel'], controller:'rightpanecontroller', viewModel:{type:'rightpanemodel'}, width:250, height:'100%', scrollable:'vertical', cls:'rightpane', autoEl:'aside', closeAction:'hide', border:true, focusable:true, tabIndex:0, tools:[], items:[], listeners:{hide:function(tab) {
  ...
  this.removeFocus();
}}, keyMap:{scope:'this', ESC:function() {
...
Ext.define('ABP.view.session.settings.SettingsContainer', {requires:['ABP.view.session.settings.SettingsContainerModel', 'ABP.view.session.settings.SettingsContainerController', 'Ext.Img', 'Ext.layout.container.Table'], extend:'ABP.view.base.rightpane.RightPanePanel', alias:'widget.settingscontainer', controller:'settingscontainer', viewModel:{type:'settingscontainer'}, cls:'settings-container', ui:'lightgrey', height:'100%', scrollable:'vertical', layout:{type:'vbox', pack:'start', align:'left'}, 
bind:{title:'{i18n.sessionMenu_settings}'}, defaults:{xtype:'button', width:'100%', cls:'settings-container-button', ui:'menuitem', uiCls:'light', textAlign:'left', toggleGroup:'settingsGroup', height:40}, dockedItems:[{xtype:'toolbar', dock:'bottom', padding:'10 10 10 15', cls:'settings-container-session-labels', ui:'lightgrey', layout:{type:'vbox', align:'stretch'}, items:[{xtype:'label', bind:{hidden:'{!showEnv || !showEnvironment}', text:'{i18n.sessionMenu_environment}' + ' {environmentName}'}}, 
{xtype:'label', reference:'sessionTimeLabel', bind:{hidden:'{!showSessionTimer}', text:'{i18n.sessionMenu_time}' + ' {loggedInTime}'}}]}], applyFocus:function() {
...
Ext.define('ABP.view.session.SessionCanvas', {extend:'Ext.panel.Panel', alias:'widget.sessioncanvas', requires:['ABP.view.session.SessionBanner', 'ABP.view.session.accessibility.JumpToBar', 'ABP.view.session.feature.FeatureCanvas', 'ABP.view.session.mainMenu.MainMenu', 'ABP.view.session.SessionCanvasController', 'ABP.view.session.rightPane.RightPane', 'ABP.view.session.settings.SettingsContainer', 'ABP.view.session.SessionCanvasModel'], controller:'sessioncanvascontroller', viewModel:{type:'sessioncanvasmodel'}, 
menuOpened:true, layout:'border', dockedItems:[{xtype:'jumptobar', dock:'top'}, {xtype:'sessionbanner', dock:'top'}, {xtype:'toolbartop', dock:'top'}], initComponent:function() {
  var me = this;
  var vm = me.getViewModel();
  ...
  vm.set('rightPaneOpen', false);
  vm.set('autoHide', autohide);
  me.items = [{xtype:'mainmenu', region:'west', viewModel:{type:'mainmenumodel', data:{classicMenuExpand:!startMenuHidden}}}, {xtype:'featurecanvas', region:'center'}, {xtype:'rightpanecanvas', region:'east', hidden:true, scrollable:false}];
  me.callParent();
  if (startMenuHidden) {
    me.closeMenu();
  }
...
Ext.define('ABP.view.session.favorites.FavoritesManagerEditPanel', {extend:'Ext.panel.Panel', requires:['ABP.view.session.favorites.FavoritesManagerEditPanelController', 'ABP.view.session.favorites.FavoritesEditPanelModel'], alias:'widget.favoriteseditpanel', controller:'favoriteseditpanel', viewModel:{type:'favoritesEditPanel'}, cls:'favoriteseditpanel', bodyCls:'x-unselectable', floating:true, modal:true, bind:{title:'{i18n.favorites_editPanel_title:htmlEncode}'}, border:true, layout:'vbox', header:{automationCls:'edit-favorites-panel-header'}, 
config:{favorite:undefined}, width:500, height:300, tools:[{iconCls:'icon-navigate-cross', handler:'onCloseClick'}], defaults:{labelAlign:'top', width:'100%', margin:'0 10 0 10'}, items:[{xtype:'textfield', allowBlank:false, cls:'a-favorites-editpanel-name', itemId:'favoriteName', bind:{fieldLabel:'{i18n.favorites_editPanel_name:htmlEncode}', disabled:'{!allowItemRename}'}}, {xtype:'textfield', cls:'a-favorites-editpanel-source', editable:false, disabled:true, itemId:'favoriteSource', bind:{fieldLabel:'{i18n.favorites_editPanel_source:htmlEncode}', 
hidden:'{!allowItemRename}'}}, {xtype:'combobox', displayField:'text', valueField:'id', cls:'a-favorites-editpanel-groups', itemId:'favoriteGroups', bind:{fieldLabel:'{i18n.favorites_editPanel_moveToGroup:htmlEncode}', hidden:'{conf.settings.favorites.depthLimit \x3d\x3d\x3d 1}'}}], bbar:{defaults:{border:false}, items:['-\x3e', {bind:{text:'{i18n.button_cancel:htmlEncode}'}, cls:'a-favorites-editpanel-bbar-cancel', width:100, handler:'onCloseClick'}, {bind:{text:'{i18n.button_delete:htmlEncode}'}, 
cls:'a-favorites-editpanel-bbar-delete', width:100, handler:'onDeleteClick'}, {bind:{text:'{i18n.button_save:htmlEncode}'}, cls:'a-favorites-editpanel-bbar-save', width:100, handler:'onSaveClick'}]}});
Ext.define('ABP.view.session.headlines.Headline', {extend:'Ext.toolbar.Toolbar', xtype:'headline', cls:'session-headline', ui:'headline', layout:{type:'hbox', pack:'right'}, constructor:function(config) {
  config = config || {};
  ...
  config.items = [{xtype:'tbtext', itemId:'headlineMessage', cls:'scrollable-overflow', html:message, flex:1}, {xtype:'abpbutton', cls:'headline-button', hidden:!allowAction, text:actionText, handler:function() {
  ...
  }}, {xtype:'tool', type:'close', role:'button', ariaLabel:'Close Headline', automationCls:'headline-read', handler:function() {
    var headline = this.up('headline'), sessionBanner = headline.up('sessionbanner');
...
Ext.define('ABP.view.session.notifications.Notifications', {extend:'ABP.view.base.rightpane.RightPanePanel', requires:['ABP.view.session.notifications.NotificationsController', 'ABP.view.session.notifications.NotificationsViewModel'], alias:'widget.abp-notifications', controller:'abp-notifications', viewModel:{type:'abp-notifications'}, ui:'lightgrey', bodyCls:'abp-notifications', layout:'card', ariaRole:'application', bind:{title:'{i18n.abp_notifications_rightpane_title}'}, items:[{xtype:'label', 
cls:'notifications-no-notifications', bind:{text:'{i18n.abp_notifications_label_no_notifications:htmlEncode}'}}, {xtype:'label', cls:'notifications-no-notifications', bind:{text:'{i18n.abp_notifications_label_no_new_notifications:htmlEncode}'}}, {xtype:'container', reference:'notificationContainer', layout:{type:'vbox', align:'stretch'}, scrollable:'y'}], applyFocus:function() {
  this.lookupReference('notificationNavComponent').focus();
}});
Ext.define('ABP.view.session.notifications.NotificationsCategoryPanel', {extend:'Ext.panel.Panel', alias:'widget.abp-notifications-category-panel', controller:'abp-notifications-category-panel', viewModel:{type:'abp-notifications-category-panel'}, config:{categoryName:null, categoryNameKey:null}, cls:'abp-notifications-category-panel a-abp-notifications-category-panel', collapsible:true, collapsed:false, collapseToolText:null, expandToolText:null, titleCollapse:true, tabIndex:-1, bind:{hidden:'{hidePanel}'}, 
header:{cls:'abp-notification-panel-header'}, items:[{xtype:'container', layout:'hbox', frame:false, items:[{xtype:'component', itemId:'notificationCategoryNavComponent', reference:'notificationCategoryNavComponent', bind:{ariaLabel:'{ariaCategoryNotificationLabel:ariaEncode}'}, tabIndex:-1, focusable:true, listeners:{keydown:{element:Ext.isModern ? 'element' : 'el', fn:'handleCategoryKeyDown'}, focus:{element:Ext.isModern ? 'element' : 'el', fn:'onCategoryNavFocus'}}}, {xtype:'component', reference:'categoryShowHistoryComponent', 
cls:'notifications-hideshow-history x-unselectable', ariaLabel:'Show History', bind:{html:'{i18n.abp_notifications_label_show_history:htmlEncode}', hidden:'{hideShowHistoryComponent}'}, listeners:{el:{click:'onShowHistoryClick'}}}, {xtype:'component', reference:'categoryHideHistoryComponent', cls:'notifications-hideshow-history x-unselectable', ariaLabel:'Hide History', bind:{html:'{i18n.abp_notifications_label_hide_history:htmlEncode}', hidden:'{hideHideHistoryComponent}'}, listeners:{el:{click:'onHideHistoryClick'}}}]}, 
{xtype:'container', reference:'unreadNotificationContainer', cls:'abp-notifications-unread-container'}, {xtype:'container', reference:'historyNotificationContainer', cls:'abp-notifications-history-container', bind:{hidden:'{!displayHistory}'}}], initComponent:function() {
  var me = this, categoryNameKey = this.getCategoryNameKey(), categoryName = this.getCategoryName(), vm = me.getViewModel();
  ...
  this.setBind({hidden:'{hidePanel}', title:'\x3cspan class\x3d"abp-notification-panel-title" tabindex\x3d"0" aria-label\x3d"' + (categoryNameKey ? '{i18n.' + categoryNameKey + ':htmlEncode}' : Ext.String.htmlEncode(categoryName)) + ' {unreadNotificationCount}"\x3e' + (categoryNameKey ? '{i18n.' + categoryNameKey + ':htmlEncode}' : Ext.String.htmlEncode(categoryName)) + '\x3c/span\x3e{categoryNotificationCountDisplay}'});
  me.callParent();
