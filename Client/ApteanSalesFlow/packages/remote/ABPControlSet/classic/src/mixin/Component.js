/**
 *  Classic component mixin.
 */
Ext.define("ABPControlSet.mixin.Component", {
    override: "ABPControlSet.base.mixin.Component",
    ...
    /**
     * Support for hidden config - getHidden is not available in classic toolkit.
     */
    getHidden: function () {
    ...
    /**
     * Support for disabled config - getDisabled is not available in classic toolkit.
     */
