...
Ext.define('overrides.Component', {override:'Ext.Component'}, function(Component) {
...
Ext.define('Overrides.BaseFieldOverride', {override:'Ext.form.field.Base', getLabelableRenderData:function() {
  var me = this, data = me.callParent();
  if (me.allowBlank === false || me.required === true) {
    if (!ABP.util.Common.getModern()) {
      data.labelCls = 'abp-mandatory ' + data.labelCls;
    }
  }
  return data;
}, privates:{elClsMap:{'labelEl':['labelCls', 'labelInnerCls'], 'bodyEl':['baseBodyCls', 'fieldBodyCls'], 'errorWrapEl':'errorWrapCls', 'errorEl':'invalidMsgCls', 'inputWrap':'inputWrapCls', 'triggerWrap':'triggerWrapCls', 'placeholderLabel':'placeholderCoverCls'}, addUIToElement:function() {
  this.callParent();
  ...
  var me = this, ui = me.ui, state = add ? 'addCls' : 'removeCls', elClsMap = me.elClsMap, key, el, mapCls, cls, mapClsLen, i;
  for (key in elClsMap) {
    el = me[key];
    mapCls = elClsMap[key];
...
Ext.theme.subThemeList = ['aptean-theme-vivid-blue', 'aptean-theme-green', 'aptean-theme-sierra', 'aptean-theme-royal', 'aptean-theme-fire', 'aptean-theme-waves', 'aptean-theme-argent', 'aptean-theme-dusk'];
Ext.theme.contrast = 'aptean-theme-nightmode';
