Ext.define('ApteanSalesFlowPackage.view.invoice.InvoiceController', {
    ...
    //Fetches the shipment data and set it to viewmodels
    ...
    //Displays the load shipment window to add shipment data to form
    onShipmentLoadButton: function () {
        Ext.create('ApteanSalesFlowPackage.view.LoadShipment.LoadShipment')
    },

    //Submit invoice details and stores it in database
    onInvoiceSubmitButton: function (sender, record) {
        ...
        let Invoice = {
            ...
            "total_Price": shipment.sales_Order.total_Value,
                ...
                Ext.Msg.show({
                    ...
                    fn: function (btn) {
                        Ext.Msg.show({
                            ...
                            fn: function (btn) {
                                if (btn == 'yes') {
                                    var report_url = "http://localhost/ReportServer/Pages/ReportViewer.aspx?%2fApteanSalesReport%2fInvoiceReport&rs:Command=Render&Invoice_Number=" + Invoice_No;
