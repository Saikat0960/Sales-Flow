Ext.define('ApteanSalesFlowPackage.view.Shipment.ShipmentController', {
    ...
    //Fetches the sales order data and set it to viewmodels
    ...
    //reset the create shipment form
    ...
    //Submit shipment details and stores it in database
    ...
    //Displays the load sales order window to add sales order data to form
